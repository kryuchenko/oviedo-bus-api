...
public final class UMathKt {
    ...
    private static final int m2194minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2131minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m2195mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m2139minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m2192maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m2119maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m2193maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m2127maxOfeb3DHEI(j, j2);
    }
}
