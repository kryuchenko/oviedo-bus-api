...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m2145getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM1112constructorimpl = ((int) ULong.m1112constructorimpl(j ^ ULong.m1112constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM1112constructorimpl2 = (iM1112constructorimpl + ((int) ULong.m1112constructorimpl(j2 ^ ULong.m1112constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM1112constructorimpl2 + ((int) (j3 ^ (j3 >>> 32)));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m1158toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m1158toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2216fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
