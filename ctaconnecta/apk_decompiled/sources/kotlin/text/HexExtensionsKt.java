...
public final class HexExtensionsKt {
    ...
    */
    public static final String toHexString(byte[] bArr, int i, int i2, HexFormat format) {
        ...
        int i4 = formattedStringLength(i2 - i3, bytesPerLine, bytesPerGroup, groupSeparator.length(), byteSeparator.length(), bytePrefix.length(), byteSuffix.length());
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m1158toStringimpl(ULong.m1112constructorimpl(j))));
    }
    ...
    private static final byte[] hexToByteArray(String str, int i, int i2, HexFormat hexFormat) {
        ...
        while (iCheckContainsAt < i2) {
            if (i5 == bytesPerLine) {
                ...
                if (i6 != 0) {
                    iCheckContainsAt = checkContainsAt(str, byteSeparator, iCheckContainsAt, i2, "byte separator");
                }
                i5++;
                i6++;
    ...
    private static final int checkContainsAt(String str, String str2, int i, int i2, String str3) {
        ...
        if (length <= i2) {
            ...
            str5 = str2;
            i3 = i;
            if (StringsKt.regionMatches(str4, i3, str5, 0, str2.length(), true)) {
                return length;
            }
        } else {
            str4 = str;
        ...
        String strSubstring = str4.substring(i3, iCoerceAtMost);
        Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String…ing(startIndex, endIndex)");
        sb.append(strSubstring);
        throw new NumberFormatException(sb.toString());
    }
