...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C02091(input, limit, null));
    }
    ...
    static final class C02091 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02091(CharSequence charSequence, int i, Continuation<? super C02091> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C02091 c02091 = Regex.this.new C02091(this.$input, this.$limit, continuation);
            c02091.L$0 = obj;
            return c02091;
        }
