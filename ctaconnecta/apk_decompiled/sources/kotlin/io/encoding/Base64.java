    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i6 != i3 || iHandlePaddingSymbol + 3 >= endIndex) {
                ...
                i2 = 1;
                int i8 = (iArr[source[iHandlePaddingSymbol] & 255] << 18) | (iArr[source[iHandlePaddingSymbol + 1] & 255] << 12) | (iArr[source[iHandlePaddingSymbol + 2] & 255] << 6) | iArr[source[iHandlePaddingSymbol + 3] & 255];
                if (i8 >= 0) {
            ...
            int i10 = source[iHandlePaddingSymbol] & 255;
            int i11 = iArr[i10];
            if (i11 >= 0) {
