...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2448boximpl(m2442markNowz9LOYto());
    }
    ...
    public long m2442markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2451constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2441elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2440differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2439adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2451constructorimpl(LongSaturatedMathKt.m2437saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
