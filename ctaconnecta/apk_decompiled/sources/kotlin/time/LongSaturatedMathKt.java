...
public final class LongSaturatedMathKt {
    ...
    public static final long m2437saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM2354toLongimpl = Duration.m2354toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2436checkInfiniteSumDefinedPjuGub4(j, j2, jM2354toLongimpl);
        }
        if (((jM2354toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m2438saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM2354toLongimpl;
        return ((j ^ j3) & (jM2354toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m2436checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2340isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2438saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM2311divUwyO8pc = Duration.m2311divUwyO8pc(j2, 2);
        long jM2354toLongimpl = Duration.m2354toLongimpl(jM2311divUwyO8pc, durationUnit);
        return (1 | (jM2354toLongimpl - 1)) == Long.MAX_VALUE ? jM2354toLongimpl : m2437saturatingAddNuflL3o(m2437saturatingAddNuflL3o(j, durationUnit, jM2311divUwyO8pc), durationUnit, Duration.m2343minusLRDsOJo(j2, jM2311divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        Duration.Companion companion = Duration.INSTANCE;
        return j < 0 ? companion.m2410getNEG_INFINITEUwyO8pc$kotlin_stdlib() : companion.m2409getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2361unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                Duration.Companion companion = Duration.INSTANCE;
                return Duration.m2344plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m2361unaryMinusUwyO8pc(infinityOfSign(j3));
        }
