...
public interface TimeMark {
    ...
    TimeMark mo2299minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2301plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2446plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2445minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2301plusLRDsOJo(Duration.m2361unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2341isNegativeimpl(timeMark.mo2298elapsedNowUwyO8pc());
        }
