...
public final class DurationKt {
    ...
    private static final long m2435timesmvk6XK0(int i, long j) {
        return Duration.m2346timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2434timeskIfJnKk(double d, long j) {
        return Duration.m2345timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2411getZEROUwyO8pc = Duration.INSTANCE.m2411getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2344plusLRDsOJo = Duration.m2344plusLRDsOJo(jM2411getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2411getZEROUwyO8pc = Duration.m2344plusLRDsOJo(jM2344plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2411getZEROUwyO8pc = Duration.m2344plusLRDsOJo(jM2411getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM2411getZEROUwyO8pc = Duration.INSTANCE.m2409getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    while (i6 < str.length()) {
                        ...
                        if (!new CharRange(c3, '9').contains(cCharAt4) && cCharAt4 != '.') {
                            break;
                        }
                        i6++;
                    }
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2344plusLRDsOJo2 = Duration.m2344plusLRDsOJo(jM2411getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2411getZEROUwyO8pc = Duration.m2344plusLRDsOJo(jM2344plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2411getZEROUwyO8pc = Duration.m2344plusLRDsOJo(jM2411getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m2361unaryMinusUwyO8pc(jM2411getZEROUwyO8pc) : jM2411getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2308constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2308constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2308constructorimpl((j << 1) + i);
    }
