        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) cCharAt2, 128) < 0) {
                ...
                if (Intrinsics.compare((int) cCharAt2, 2048) < 0) {
                    ...
                    yield.invoke(Byte.valueOf((byte) ((cCharAt2 >> '\f') | PassportService.DEFAULT_MAX_BLOCKSIZE)));
                    yield.invoke(Byte.valueOf((byte) (((cCharAt2 >> 6) & 63) | 128)));
                    yield.invoke(Byte.valueOf((byte) ((cCharAt2 & '?') | 128)));
                } else if (Intrinsics.compare((int) cCharAt2, GeneratorBase.SURR1_LAST) > 0 || i2 <= (i3 = i + 1) || 56320 > (cCharAt = processUtf8Bytes.charAt(i3)) || 57343 < cCharAt) {
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i6) {
                        ...
                        int i7 = i + 1;
                        if (i2 <= i7 || (processUtf8CodePoints[i7] & ISO7816.INS_GET_RESPONSE) != 128) {
                            i3 = 1;
                        }
                        i += i3;
                    } else {
                    ...
                    if (i2 <= i9) {
                        ...
                        int i10 = i + 1;
                        if (i2 > i10 && (processUtf8CodePoints[i10] & ISO7816.INS_GET_RESPONSE) == 128) {
                            int i11 = i + 2;
                            if (i2 > i11 && (processUtf8CodePoints[i11] & ISO7816.INS_GET_RESPONSE) == 128) {
                                i3 = 3;
                            }
                        }
                        i += i3;
    ...
    */
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i6) {
                        ...
                        Unit unit3 = Unit.INSTANCE;
                        int i7 = i + 1;
                        if (i2 <= i7 || (processUtf16Chars[i7] & ISO7816.INS_GET_RESPONSE) != 128) {
                            i3 = 1;
                        }
                        i += i3;
                    } else {
                    ...
                    if (i2 <= i9) {
                        ...
                        Unit unit7 = Unit.INSTANCE;
                        int i10 = i + 1;
                        if (i2 > i10 && (processUtf16Chars[i10] & ISO7816.INS_GET_RESPONSE) == 128) {
                            int i11 = i + 2;
                            if (i2 > i11 && (processUtf16Chars[i11] & ISO7816.INS_GET_RESPONSE) == 128) {
                                i3 = 3;
                            }
                        }
                        i += i3;
    ...
    public static final int process3Utf8Bytes(byte[] process3Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            yield.invoke(numValueOf);
            int i4 = i + 1;
            return (i2 <= i4 || (process3Utf8Bytes[i4] & ISO7816.INS_GET_RESPONSE) != 128) ? 1 : 2;
        }
    ...
    public static final int process4Utf8Bytes(byte[] process4Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        if (i2 <= i3) {
            yield.invoke(numValueOf);
            int i4 = i + 1;
            if (i2 <= i4 || (process4Utf8Bytes[i4] & ISO7816.INS_GET_RESPONSE) != 128) {
                return 1;
            }
            int i5 = i + 2;
            return (i2 <= i5 || (process4Utf8Bytes[i5] & ISO7816.INS_GET_RESPONSE) != 128) ? 2 : 3;
        }
