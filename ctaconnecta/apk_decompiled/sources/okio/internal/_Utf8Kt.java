            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i12) {
                        ...
                        int i13 = i8 + 1;
                        i4 = (i2 <= i13 || (commonToUtf8String[i13] & ISO7816.INS_GET_RESPONSE) != 128) ? 1 : 2;
                    } else {
                    ...
                    if ((b >> 3) == -2) {
                        ...
                        if (i2 <= i15) {
                            ...
                            int i16 = i8 + 1;
                            if (i2 > i16 && (commonToUtf8String[i16] & ISO7816.INS_GET_RESPONSE) == 128) {
                                int i17 = i8 + 2;
                                i7 = (i2 <= i17 || (commonToUtf8String[i17] & ISO7816.INS_GET_RESPONSE) != 128) ? 2 : 3;
                            }
                            i7 = 1;
                        } else {
            ...
            if (Intrinsics.compare((int) cCharAt2, 128) >= 0) {
                ...
                while (i2 < length2) {
                    ...
                    if (Intrinsics.compare((int) cCharAt3, 128) < 0) {
                        ...
                        } else if (Intrinsics.compare((int) cCharAt3, GeneratorBase.SURR1_LAST) > 0 || length2 <= (i = i2 + 1) || 56320 > (cCharAt = commonAsUtf8ToByteArray.charAt(i)) || 57343 < cCharAt) {
