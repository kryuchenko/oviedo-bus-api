...
public final class NavigationUI {
    ...
    @JvmStatic
    public static final boolean onNavDestinationSelected(MenuItem item, NavController navController) throws Resources.NotFoundException {
        ...
        try {
            ...
            Log.i(TAG, "Ignoring onNavDestinationSelected for MenuItem " + NavDestination.INSTANCE.getDisplayName(navController.getContext(), item.getItemId()) + " as it cannot be found from the current destination " + navController.getCurrentDestination(), e);
            return false;
        }
    }
    ...
    @JvmStatic
    public static final boolean onNavDestinationSelected(MenuItem item, NavController navController, boolean saveState) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter(item, "item");
        Intrinsics.checkNotNullParameter(navController, "navController");
        if (saveState) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean setupWithNavController$lambda$5(NavController navController, boolean z, NavigationView navigationView, MenuItem item) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter(navController, "$navController");
        Intrinsics.checkNotNullParameter(navigationView, "$navigationView");
        Intrinsics.checkNotNullParameter(item, "item");
