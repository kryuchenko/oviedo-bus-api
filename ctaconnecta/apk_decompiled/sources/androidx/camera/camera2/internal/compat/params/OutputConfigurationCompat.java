...
public final class OutputConfigurationCompat {
    ...
    public static OutputConfigurationCompat wrap(Object obj) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            outputConfigurationCompatImplWrap = OutputConfigurationCompatApi28Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m14m(obj));
        } else if (Build.VERSION.SDK_INT >= 26) {
            outputConfigurationCompatImplWrap = OutputConfigurationCompatApi26Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m14m(obj));
        } else {
            outputConfigurationCompatImplWrap = Build.VERSION.SDK_INT >= 24 ? OutputConfigurationCompatApi24Impl.wrap(ComponentDialog$$ExternalSyntheticApiModelOutline0.m14m(obj)) : null;
        }
