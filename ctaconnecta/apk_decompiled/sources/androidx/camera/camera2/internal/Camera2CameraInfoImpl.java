...
public final class Camera2CameraInfoImpl implements CameraInfoInternal {
    ...
    */
    public int getSensorRotationDegrees(int i) {
        ...
        Integer numValueOf = Integer.valueOf(sensorOrientation);
        int iSurfaceRotationToDegrees = CameraOrientationUtil.surfaceRotationToDegrees(i);
        Integer lensFacing = getLensFacing();
        if (lensFacing != null) {
            z = 1 == lensFacing.intValue();
        }
        numValueOf.getClass();
        return CameraOrientationUtil.getRelativeImageRotation(iSurfaceRotationToDegrees, sensorOrientation, z);
    }
