...
class FocusMeteringControl {
    ...
    ListenableFuture<FocusMeteringResult> startFocusAndMetering(final FocusMeteringAction focusMeteringAction) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m79xb5d4fd7e(focusMeteringAction, completer);
            }
        });
    }
    ...
    /* synthetic */ Object m79xb5d4fd7e(final FocusMeteringAction focusMeteringAction, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda6
            ...
            public final void run() {
                this.f$0.m78x8c80a83d(completer, focusMeteringAction);
            }
        });
    ...
    public void m78x8c80a83d(CallbackToFutureAdapter.Completer<FocusMeteringResult> completer, FocusMeteringAction focusMeteringAction) {
        if (!this.mIsActive) {
    ...
    private void executeMeteringAction(MeteringRectangle[] meteringRectangleArr, MeteringRectangle[] meteringRectangleArr2, MeteringRectangle[] meteringRectangleArr3, FocusMeteringAction focusMeteringAction) {
        ...
        Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda1
            ...
            public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                return this.f$0.m75xfc1c23a9(zIsAfModeSupported, jUpdateSessionConfigSynchronous, totalCaptureResult);
            }
        };
        ...
        if (focusMeteringAction.isAutoCancelEnabled()) {
            ...
            this.mAutoCancelHandle = this.mScheduler.schedule(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m77x4ec4ce2b(j);
                }
    ...
    /* synthetic */ boolean m75xfc1c23a9(boolean z, long j, TotalCaptureResult totalCaptureResult) {
    ...
    /* synthetic */ void m77x4ec4ce2b(final long j) {
    ...
    /* synthetic */ void m76x257078ea(long j) {
    ...
    ListenableFuture<Void> cancelFocusAndMetering() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda4
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m73xb24c9a75(completer);
            }
        });
    }
    ...
    /* synthetic */ Object m73xb24c9a75(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m72x88f84534(completer);
            }
        });
    ...
    public void m72x88f84534(CallbackToFutureAdapter.Completer<Void> completer) {
        ...
        if (this.mRunningCancelCompleter != null) {
            ...
            Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda3
                @Override // androidx.camera.camera2.internal.Camera2CameraControlImpl.CaptureResultListener
                public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                    return this.f$0.m74x2811a093(supportedAfMode, jUpdateSessionConfigSynchronous, totalCaptureResult);
                }
            };
    ...
    /* synthetic */ boolean m74x2811a093(int i, long j, TotalCaptureResult totalCaptureResult) {
