    ...
    static ForwardingImageProxy downsample(ImageProxy imageProxy, int i, int i2, DownsamplingMethod downsamplingMethod) {
        ...
        for (int i6 = 0; i6 < 3; i6++) {
            ...
            if (i7 == 1) {
                ...
                i3 = 1;
                resizeNearestNeighbor(buffer, i8, pixelStride, rowStride, iArr2[i6], bArr, iArr3[i6], iArr4[i6]);
            } else if (i7 == 2) {
                bArr = bArr3;
                int i9 = iArr[i6];
                ...
                i3 = 1;
                resizeAveraging(buffer, i9, pixelStride2, rowStride2, iArr2[i6], bArr, iArr3[i6], iArr4[i6]);
            } else {
                bArr2 = bArr3;
                i3 = 1;
