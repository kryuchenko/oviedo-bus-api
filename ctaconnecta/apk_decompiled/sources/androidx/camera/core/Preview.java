...
public final class Preview extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final PreviewConfig previewConfig, final Size size) {
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.Preview$$ExternalSyntheticLambda1
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m160lambda$createPipeline$0$androidxcameracorePreview(str, previewConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m160lambda$createPipeline$0$androidxcameracorePreview(String str, PreviewConfig previewConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
