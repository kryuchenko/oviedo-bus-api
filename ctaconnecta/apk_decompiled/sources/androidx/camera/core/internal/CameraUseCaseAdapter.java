...
public final class CameraUseCaseAdapter implements Camera {
    ...
    public void addUseCases(Collection<UseCase> collection) throws CameraException {
        synchronized (this.mLock) {
            ...
            List<UseCase> listCalculateRequiredExtraUseCases = Collections.EMPTY_LIST;
            List<UseCase> arrayList3 = Collections.EMPTY_LIST;
            if (isCoexistingPreviewImageCaptureRequired()) {
                arrayList2.removeAll(this.mExtraUseCases);
                arrayList2.addAll(arrayList);
                listCalculateRequiredExtraUseCases = calculateRequiredExtraUseCases(arrayList2, new ArrayList<>(this.mExtraUseCases));
                ArrayList arrayList4 = new ArrayList(listCalculateRequiredExtraUseCases);
                arrayList4.removeAll(this.mExtraUseCases);
                arrayList.addAll(arrayList4);
                arrayList3 = new ArrayList<>(this.mExtraUseCases);
                arrayList3.removeAll(listCalculateRequiredExtraUseCases);
            }
            ...
            try {
                List<UseCase> arrayList5 = new ArrayList<>(this.mUseCases);
                ...
                this.mExtraUseCases = listCalculateRequiredExtraUseCases;
    ...
    public void removeUseCases(Collection<UseCase> collection) {
        synchronized (this.mLock) {
            ...
            if (isCoexistingPreviewImageCaptureRequired()) {
                ...
                try {
                    addUseCases(Collections.EMPTY_LIST);
    ...
    public boolean isUseCasesCombinationSupported(UseCase... useCaseArr) {
        synchronized (this.mLock) {
            try {
                try {
                    calculateSuggestedResolutions(this.mCameraInternal.getCameraInfoInternal(), Arrays.asList(useCaseArr), Collections.EMPTY_LIST, getConfigs(Arrays.asList(useCaseArr), this.mCameraConfig.getUseCaseConfigFactory(), this.mUseCaseConfigFactory));
