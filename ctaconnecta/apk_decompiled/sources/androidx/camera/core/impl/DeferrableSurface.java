...
public abstract class DeferrableSurface {
        ...
        if (Logger.isDebugEnabled(TAG)) {
            ...
            future.addListener(new Runnable() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m180lambda$new$1$androidxcameracoreimplDeferrableSurface(stackTraceString);
                }
    ...
    /* synthetic */ void m180lambda$new$1$androidxcameracoreimplDeferrableSurface(String str) {
        try {
