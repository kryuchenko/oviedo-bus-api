...
public final class VideoCapture extends UseCase {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:62:0x01b3
    ...
    public void m169lambda$startRecording$0$androidxcameracoreVideoCapture(final androidx.camera.core.VideoCapture.OutputFileOptions r10, final java.util.concurrent.Executor r11, final androidx.camera.core.VideoCapture.OnVideoSavedCallback r12) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 471
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.VideoCapture.m169lambda$startRecording$0$androidxcameracoreVideoCapture(androidx.camera.core.VideoCapture$OutputFileOptions, java.util.concurrent.Executor, androidx.camera.core.VideoCapture$OnVideoSavedCallback):void");
    }
    ...
    /* synthetic */ void m170lambda$startRecording$2$androidxcameracoreVideoCapture() {
        this.mRecordingFuture = null;
        if (getCamera() != null) {
    ...
    /* synthetic */ void m172lambda$startRecording$4$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions, CallbackToFutureAdapter.Completer completer) {
    ...
    public void m173lambda$stopRecording$5$androidxcameracoreVideoCapture() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m173lambda$stopRecording$5$androidxcameracoreVideoCapture();
                }
            });
            return;
        }
    ...
    public void onDetached() {
        m173lambda$stopRecording$5$androidxcameracoreVideoCapture();
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.core.VideoCapture$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m168lambda$onDetached$6$androidxcameracoreVideoCapture();
                }
            }, CameraXExecutors.mainThreadExecutor());
        } else {
            m168lambda$onDetached$6$androidxcameracoreVideoCapture();
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: releaseResources, reason: merged with bridge method [inline-methods] */
    public void m168lambda$onDetached$6$androidxcameracoreVideoCapture() {
    ...
    boolean videoEncode(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions) throws IOException {
        ...
        while (!zWriteVideoEncodedBuffer && !z) {
            ...
            int iDequeueOutputBuffer = this.mVideoEncoder.dequeueOutputBuffer(this.mVideoBufferInfo, DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM);
    ...
    public boolean m171lambda$startRecording$3$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback) throws IllegalStateException, MediaCodec.CryptoException {
        long j = 0;
    ...
    private AudioRecord autoConfigAudioRecordSource(VideoCaptureConfig videoCaptureConfig) {
        ...
        try {
            ...
            AudioRecord audioRecord = new AudioRecord(5, this.mAudioSampleRate, i, 2, minBufferSize * 2);
            if (audioRecord.getState() != 1) {
                return null;
            }
            this.mAudioBufferSize = minBufferSize;
            Logger.i(TAG, "source: 5 audioSampleRate: " + this.mAudioSampleRate + " channelConfig: " + i + " audioFormat: 2 bufferSize: " + minBufferSize);
            return audioRecord;
        } catch (Exception e) {
    ...
    static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        /* synthetic */ void m175x99849d14(OutputFileResults outputFileResults) {
        ...
        public void onVideoSaved(final OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m175x99849d14(outputFileResults);
                    }
                });
        ...
        public void onError(final int i, final String str, final Throwable th) {
            try {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.core.VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.m174xe8a64259(i, str, th);
                    }
                });
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCapture.TAG, "Unable to post to the supplied executor.");
        ...
        /* synthetic */ void m174xe8a64259(int i, String str, Throwable th) {
