...
public final class ImageAnalysis extends UseCase {
    ...
    SessionConfig.Builder createPipeline(final String str, final ImageAnalysisConfig imageAnalysisConfig, final Size size) {
        ...
        immediateSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda1
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageAnalysis$$ExternalSyntheticLambda2
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f$0.m141lambda$createPipeline$1$androidxcameracoreImageAnalysis(str, imageAnalysisConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m141lambda$createPipeline$1$androidxcameracoreImageAnalysis(String str, ImageAnalysisConfig imageAnalysisConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        clearPipeline();
