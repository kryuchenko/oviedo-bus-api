    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (i2 == 0) {
            ...
            while (i10 < i) {
                ...
                int i12 = i4;
                boolean z = (i9 == i7 || (flow2.mHorizontalGap + i9) + widgetWidth > i7) && widgetsList.biggest != null;
                if (!z && i10 > 0 && (i6 = flow2.mMaxElementsWrap) > 0 && i11 > i6) {
                    z = true;
                }
                if (z) {
                    widgetsList = flow2.new WidgetsList(i2, flow2.mLeft, flow2.mTop, flow2.mRight, flow2.mBottom, i7);
            ...
            while (i14 < i) {
                ...
                int i15 = i4;
                boolean z2 = (i13 == i7 || (flow2.mVerticalGap + i13) + widgetHeight > i7) && widgetsList.biggest != null;
                if (!z2 && i14 > 0 && (i5 = flow2.mMaxElementsWrap) > 0 && i5 < 0) {
                    z2 = true;
                }
                if (z2) {
                    widgetsList = flow2.new WidgetsList(i2, flow2.mLeft, flow2.mTop, flow2.mRight, flow2.mBottom, i7);
        ...
        for (int i21 = 0; i21 < size; i21++) {
            ...
            if (i2 == 0) {
                ...
                ConstraintAnchor constraintAnchor10 = widgetsList3.biggest.mBottom;
                int i22 = i17;
                widgetsList3.setup(i2, constraintAnchor9, constraintAnchor6, constraintAnchor8, constraintAnchor7, i19, i18, paddingRight2, paddingBottom2, i3);
                int iMax = Math.max(i20, widgetsList3.getWidth());
