...
public abstract class MeasurementManager {
    ...
    private static final class Api33Ext5Impl extends MeasurementManager {
        ...
        public Api33Ext5Impl(Context context) {
            ...
            Object systemService = context.getSystemService((Class<Object>) EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m$2());
            Intrinsics.checkNotNullExpressionValue(systemService, "context.getSystemService…:class.java\n            )");
            this(EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m373m(systemService));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public final android.adservices.measurement.DeletionRequest convertDeletionRequest(DeletionRequest request) {
            android.adservices.measurement.DeletionRequest deletionRequestBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m372m().setDeletionMode(request.getDeletionMode()).setMatchBehavior(request.getMatchBehavior()).setStart(request.getStart()).setEnd(request.getEnd()).setDomainUris(request.getDomainUris()).setOriginUris(request.getOriginUris()).build();
        ...
        public final android.adservices.measurement.WebSourceRegistrationRequest convertWebSourceRequest(WebSourceRegistrationRequest request) {
            EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m384m();
            android.adservices.measurement.WebSourceRegistrationRequest webSourceRegistrationRequestBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m((List) convertWebSourceParams(request.getWebSourceParams()), request.getTopOriginUri()).setWebDestination(request.getWebDestination()).setAppDestination(request.getAppDestination()).setInputEvent(request.getInputEvent()).setVerifiedDestination(request.getVerifiedDestination()).build();
        ...
        private final List<android.adservices.measurement.WebSourceParams> convertWebSourceParams(List<WebSourceParams> request) {
            ...
            for (WebSourceParams webSourceParams : request) {
                EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m388m$3();
                android.adservices.measurement.WebSourceParams webSourceParamsBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m(webSourceParams.getRegistrationUri()).setDebugKeyAllowed(webSourceParams.getDebugKeyAllowed()).build();
        ...
        public final android.adservices.measurement.WebTriggerRegistrationRequest convertWebTriggerRequest(WebTriggerRegistrationRequest request) {
            EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m386m$1();
            android.adservices.measurement.WebTriggerRegistrationRequest webTriggerRegistrationRequestBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m375m((List) convertWebTriggerParams(request.getWebTriggerParams()), request.getDestination()).build();
        ...
        private final List<android.adservices.measurement.WebTriggerParams> convertWebTriggerParams(List<WebTriggerParams> request) {
            ...
            for (WebTriggerParams webTriggerParams : request) {
                EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m387m$2();
                android.adservices.measurement.WebTriggerParams webTriggerParamsBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m374m(webTriggerParams.getRegistrationUri()).setDebugKeyAllowed(webTriggerParams.getDebugKeyAllowed()).build();
