...
public abstract class CustomAudienceManager {
    ...
    private static final class Api33Ext4Impl extends CustomAudienceManager {
        ...
        public Api33Ext4Impl(Context context) {
            ...
            Object systemService = context.getSystemService((Class<Object>) EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m$1());
            Intrinsics.checkNotNullExpressionValue(systemService, "context.getSystemService…:class.java\n            )");
            this(EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m368m(systemService));
        }
        ...
        public final android.adservices.customaudience.JoinCustomAudienceRequest convertJoinRequest(JoinCustomAudienceRequest request) {
            android.adservices.customaudience.JoinCustomAudienceRequest joinCustomAudienceRequestBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m369m().setCustomAudience(convertCustomAudience(request.getCustomAudience())).build();
        ...
        public final android.adservices.customaudience.LeaveCustomAudienceRequest convertLeaveRequest(LeaveCustomAudienceRequest request) {
            android.adservices.customaudience.LeaveCustomAudienceRequest leaveCustomAudienceRequestBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m370m().setBuyer(convertAdTechIdentifier(request.getBuyer())).setName(request.getName()).build();
        ...
        private final List<AdData> convertAdData(List<androidx.privacysandbox.ads.adservices.common.AdData> input) {
            ...
            for (androidx.privacysandbox.ads.adservices.common.AdData adData : input) {
                AdData adDataBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m().setMetadata(adData.getMetadata()).setRenderUri(adData.getRenderUri()).build();
        ...
        private final android.adservices.customaudience.TrustedBiddingData convertTrustedSignals(TrustedBiddingData input) {
            ...
            return EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m371m().setTrustedBiddingKeys(input.getTrustedBiddingKeys()).setTrustedBiddingUri(input.getTrustedBiddingUri()).build();
        }
