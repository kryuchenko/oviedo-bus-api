...
public final class TopicsManagerApi33Ext5Impl extends TopicsManagerImplCommon {
    ...
    public TopicsManagerApi33Ext5Impl(Context context) {
        ...
        Object systemService = context.getSystemService((Class<Object>) EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m$3());
        Intrinsics.checkNotNullExpressionValue(systemService, "context.getSystemService…opicsManager::class.java)");
        super(EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m379m(systemService));
    }
    ...
    public android.adservices.topics.GetTopicsRequest convertRequest$ads_adservices_release(GetTopicsRequest request) {
        ...
        android.adservices.topics.GetTopicsRequest getTopicsRequestBuild = EncryptedSharedPreferences$$ExternalSyntheticApiModelOutline0.m376m().setAdsSdkName(request.getAdsSdkName()).setShouldRecordObservation(request.getShouldRecordObservation()).build();
