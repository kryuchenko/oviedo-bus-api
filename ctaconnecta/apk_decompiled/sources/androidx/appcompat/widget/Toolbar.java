...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(i5 + iMax2 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i, (-16777216) & iCombineMeasuredStates2), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(iMax6 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i2, iCombineMeasuredStates2 << 16));
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:116:0x02f0 A[LOOP:2: B:115:0x02ee->B:116:0x02f0, LOOP_END] */
