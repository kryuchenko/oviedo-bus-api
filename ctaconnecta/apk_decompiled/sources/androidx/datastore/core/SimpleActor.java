...
public final class SimpleActor<T> {
    ...
    public SimpleActor(CoroutineScope scope, final Function1<? super Throwable, Unit> onComplete, final Function2<? super T, ? super Throwable, Unit> onUndeliveredElement, Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> consumeMessage) {
        ...
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
            ...
            public final void invoke2(Throwable th) {
                ...
                do {
                    Object objM2499getOrNullimpl = ChannelResult.m2499getOrNullimpl(((SimpleActor) this).messageQueue.mo2489tryReceivePtdJZtk());
                    if (objM2499getOrNullimpl == null) {
                        unit = null;
                    } else {
                        onUndeliveredElement.invoke(objM2499getOrNullimpl, th);
                        unit = Unit.INSTANCE;
                    }
                } while (unit != null);
            }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo2484trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM2498exceptionOrNullimpl = ChannelResult.m2498exceptionOrNullimpl(obj);
            if (thM2498exceptionOrNullimpl != null) {
                throw thM2498exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m2504isSuccessimpl(obj)) {
