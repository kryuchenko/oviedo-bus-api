...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C01381 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01381(Set<String> set, Continuation<? super C01381> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01381 c01381 = new C01381(this.$keysToMigrate, continuation);
            c01381.L$0 = obj;
            return c01381;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C01381) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
