...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C01371 extends ContinuationImpl {
        ...
        C01371(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C01371> continuation) {
            super(continuation);
    ...
    */
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C01371) {
            ...
            if ((c01371.label & Integer.MIN_VALUE) != 0) {
                ...
                c01371 = new C01371(this, continuation);
            }
        }
        Object objInvoke = c01371.result;
        ...
        if (i == 0) {
            ...
            c01371.L$0 = this;
            c01371.label = 1;
            objInvoke = function2.invoke(t, c01371);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c01371.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
    ...
    /* compiled from: SharedPreferencesMigration.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", AppMeasurementSdk.ConditionalUserProperty.NAME, "", "datastore_release"}, k = 1, mv = {1, 5, 1}, xi = 48)
