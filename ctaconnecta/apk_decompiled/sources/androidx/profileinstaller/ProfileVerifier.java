            ...
            if (!z) {
                ...
                if (Build.VERSION.SDK_INT >= 28 && Build.VERSION.SDK_INT != 30) {
                    ...
                    try {
                        ...
                        int i2 = (fromFile == null && fromFile.mResultCode == 2 && i == 1 && length < fromFile.mInstalledCurrentProfileSize) ? 3 : i;
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                if (file22.exists()) {
                    ...
                    if (file32.exists()) {
                        ...
                        cache = new Cache(1, i2, packageLastUpdateTime2, length2);
                        if (fromFile != null) {
                            cache.writeOnFile(file);
                        }
                        return setCompilationStatus(i2, z2, z3);
