...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM4m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m4m((Object) it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelM4m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelM4m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelM4m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM5m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m5m((Object) it.next());
                if (Api26Impl.getId(notificationChannelGroupM5m).equals(str)) {
                    return notificationChannelGroupM5m;
                }
            }
        }
        return null;
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM5m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m5m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM5m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM5m, notificationChannels));
                    }
                }
                return arrayList;
            }
