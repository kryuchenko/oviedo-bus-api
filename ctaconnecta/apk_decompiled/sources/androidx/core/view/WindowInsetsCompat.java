...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m269m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM269m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM269m = HalfKt$$ExternalSyntheticApiModelOutline0.m270m(windowInsets);
            } else {
                builderM269m = HalfKt$$ExternalSyntheticApiModelOutline0.m269m();
            }
            this.mPlatBuilder = builderM269m;
        }
