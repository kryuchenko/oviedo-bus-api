...
public final class LongSparseArrayKt {
    ...
    public static final class C01231<T> implements Iterator<T>, KMappedMarker {
        ...
        C01231(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> longSparseArray) {
        return new C01231(longSparseArray);
    }
