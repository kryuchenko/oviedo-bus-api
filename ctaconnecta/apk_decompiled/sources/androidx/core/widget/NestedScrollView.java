    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        if (!zCanScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                if (viewFindNextFocus != null && viewFindNextFocus != this && viewFindNextFocus.requestFocus(ISO781611.BIOMETRIC_SUBTYPE_TAG)) {
                    return true;
                }
            }
            return false;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 20) {
                if (keyEvent.isAltPressed()) {
                    return fullScroll(ISO781611.BIOMETRIC_SUBTYPE_TAG);
                }
                return arrowScroll(ISO781611.BIOMETRIC_SUBTYPE_TAG);
            }
            if (keyCode == 62) {
            ...
            if (keyCode == 123) {
                pageScroll(ISO781611.BIOMETRIC_SUBTYPE_TAG);
                return false;
            }
        }
        return false;
