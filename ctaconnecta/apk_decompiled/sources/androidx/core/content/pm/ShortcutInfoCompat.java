...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo.Builder intents = ComponentDialog$$ExternalSyntheticApiModelOutline0.m8m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
