...
public class PACEProtocol {
    ...
    private static final byte[] C1_LENGTH_256 = {84, -67, 114, 85, -16, -86, -8, 49, -66, -61, CVCAFile.CAR_TAG, Utf8.REPLACEMENT_BYTE, -49, 57, ISO7816.INS_UPDATE_BINARY, -101, 108, ByteSourceJsonBootstrapper.UTF8_BOM_3, 6, 102, 119, ISO7816.INS_WRITE_BINARY, -6, -82, 90, -83, -39, -99, -8, -27, 53, Ascii.ETB};
    ...
    /* JADX WARN: Not initialized variable reg: 4, insn: 0x00d5: INVOKE (r4 I:net.sf.scuba.tlv.TLVInputStream) VIRTUAL call: net.sf.scuba.tlv.TLVInputStream.close():void A[Catch: IOException -> 0x00d9, GeneralSecurityException -> 0x00e2, MD:():void throws java.io.IOException (m), TRY_ENTER, TRY_LEAVE] (LINE:674), block:B:39:0x00d5 */
    public byte[] doPACEStep4(String str, PACEInfo.MappingType mappingType, KeyPair keyPair, PublicKey publicKey, SecretKey secretKey) throws IOException, CardServiceException {
        ...
        try {
            ...
            throw new PACEException("PCD side exception in authentication token generation step", e3);
        }
        ...
        try {
            ...
            LOGGER.log(Level.FINE, "Exception closing stream", (Throwable) e5);
            return value2;
        }
        throw new PACEException("PCD side exception in authentication token generation step", e3);
    }
