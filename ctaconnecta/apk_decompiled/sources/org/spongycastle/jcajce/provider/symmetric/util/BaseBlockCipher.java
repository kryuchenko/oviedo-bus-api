...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARN: Type inference failed for: r2v78, types: [org.spongycastle.crypto.params.ParametersWithIV] */
    /* JADX WARN: Type inference failed for: r8v11 */
    /* JADX WARN: Type inference failed for: r8v19 */
    /* JADX WARN: Type inference failed for: r8v20 */
    /* JADX WARN: Type inference failed for: r8v21, types: [org.spongycastle.crypto.params.ParametersWithIV] */
    /* JADX WARN: Type inference failed for: r8v23, types: [org.spongycastle.crypto.CipherParameters] */
    /* JADX WARN: Type inference failed for: r8v28, types: [org.spongycastle.crypto.params.AEADParameters] */
    ...
    /* JADX WARN: Type inference failed for: r8v8, types: [org.spongycastle.crypto.CipherParameters] */
    @Override // org.spongycastle.jcajce.provider.symmetric.util.BaseWrapCipher, javax.crypto.CipherSpi
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws NoSuchMethodException, InvalidKeyException, SecurityException, InvalidAlgorithmParameterException {
        ...
        if (i2 == 2 || (key instanceof PKCS12Key)) {
            ...
            aEADParameters = cipherParametersMakePBEParameters4;
            if (z5) {
        ...
        if (algorithmParameterSpec instanceof AEADParameterSpec) {
            ...
            if (this.ivLength != 0) {
                ...
                if (aEADParameters instanceof ParametersWithIV) {
                    parametersWithIV2 = new ParametersWithIV(((ParametersWithIV) aEADParameters).getParameters(), ivParameterSpec.getIV());
                } else {
                    parametersWithIV2 = new ParametersWithIV(aEADParameters, ivParameterSpec.getIV());
                }
            ...
            if (this.baseEngine.getAlgorithmName().startsWith("RC5")) {
                if (!this.baseEngine.getAlgorithmName().equals("RC5-32")) {
                    if (this.baseEngine.getAlgorithmName().equals("RC5-64") && rC5ParameterSpec.getWordSize() != 64) {
            ...
            if (cls != null && cls.isInstance(algorithmParameterSpec)) {
                ...
                try {
                    ...
                    AEADParameters aEADParameters2 = new AEADParameters(keyParameter, ((Integer) declaredMethod.invoke(algorithmParameterSpec, null)).intValue(), (byte[]) declaredMethod2.invoke(algorithmParameterSpec, null));
        ...
        ParametersWithRandom parametersWithRandom = aEADParameters;
        if (this.ivLength != 0) {
            boolean z6 = aEADParameters instanceof ParametersWithIV;
            parametersWithRandom = aEADParameters;
            if (!z6) {
                boolean z7 = aEADParameters instanceof AEADParameters;
                parametersWithRandom = aEADParameters;
                if (!z7) {
                    ...
                    if (i == 1 || i == 3) {
                        ...
                        ?? parametersWithIV3 = new ParametersWithIV(aEADParameters, bArr);
