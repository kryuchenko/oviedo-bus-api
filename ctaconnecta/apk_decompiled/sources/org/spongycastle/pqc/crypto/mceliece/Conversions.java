    ...
    public static GF2Vector encode(int i, int i2, byte[] bArr) {
        ...
        for (int i4 = 0; i4 < i; i4++) {
            ...
            if (bigIntegerBinomial.compareTo(bigInteger) <= 0) {
                ...
                int i5 = i2 - 1;
                if (i3 == i5) {
                    bigIntegerDivide = ONE;
                } else {
                    bigIntegerDivide = bigIntegerBinomial.multiply(BigInteger.valueOf(i2)).divide(BigInteger.valueOf(i3 - i5));
                }
                bigIntegerBinomial = bigIntegerDivide;
                i2 = i5;
            }
        }
        return gF2Vector;
        ...
        for (int i10 = 0; i10 < i; i10++) {
            ...
            if (((byte) (bArr2[i10 >>> 3] & (1 << (i10 & 7)))) != 0) {
                ...
                if (i9 == i11) {
                    ...
                    bigIntegerDivide = bigIntegerBinomial.multiply(new BigInteger(Integer.toString(i2))).divide(new BigInteger(Integer.toString(i9 - i11)));
                }
                bigIntegerBinomial = bigIntegerDivide;
                i2 = i11;
            }
