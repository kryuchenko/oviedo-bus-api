...
public class PKIXCertPathValidatorSpi extends CertPathValidatorSpi {
    ...
    /* JADX WARN: Type inference failed for: r4v5, types: [org.spongycastle.asn1.x509.AlgorithmIdentifier] */
    ...
    public CertPathValidatorResult engineValidate(CertPath certPath, CertPathParameters certPathParameters) throws CertificateNotYetValidException, IOException, CertPathValidatorException, CertificateExpiredException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            for (int i = 0; i < iPrepareNextCertI2; i++) {
            ...
            int i2 = pKIXExtendedParametersBuild.isExplicitPolicyRequired() ? 0 : iPrepareNextCertI2;
            int i3 = pKIXExtendedParametersBuild.isAnyPolicyInhibited() ? 0 : iPrepareNextCertI2;
                ...
                try {
                    ...
                    while (size2 >= 0) {
                        ...
                        try {
                            ...
                            RFC3280CertPathUtilities.processCertA(certPath, pKIXExtendedParametersBuild, size2, publicKey, z, subjectPrincipal, x509Certificate, jcaJceHelper);
                            ...
                            int i8 = size2;
                            RFC3280CertPathUtilities.processCertBC(certPath, i8, pKIXNameConstraintValidator3);
                            HashSet hashSet5 = hashSet4;
                            int i9 = i5;
                            PKIXPolicyNode pKIXPolicyNodeProcessCertE = RFC3280CertPathUtilities.processCertE(certPath, i8, RFC3280CertPathUtilities.processCertD(certPath, i8, hashSet5, pKIXPolicyNode2, arrayListArr2, i9));
                            RFC3280CertPathUtilities.processCertF(certPath, i8, pKIXPolicyNodeProcessCertE, i6);
                            hashSet4 = hashSet5;
                            if (i7 != size) {
                                if (x509Certificate3 != null) {
                                    pKIXExtendedParameters = pKIXExtendedParameters2;
                                    if (x509Certificate3.getVersion() == 1) {
                                        if (i7 != 1 || !x509Certificate3.equals(trustAnchor.getTrustedCert())) {
                                            throw new CertPathValidatorException("Version 1 certificates can't be used as CA ones.", null, certPath, i8);
                                        }
                                    }
                                } else {
                                    pKIXExtendedParameters = pKIXExtendedParameters2;
                                }
                                RFC3280CertPathUtilities.prepareNextCertA(certPath, i8);
                                pKIXPolicyNodePrepareCertB = RFC3280CertPathUtilities.prepareCertB(certPath, i8, arrayListArr2, pKIXPolicyNodeProcessCertE, iPrepareNextCertI2);
                                RFC3280CertPathUtilities.prepareNextCertG(certPath, i8, pKIXNameConstraintValidator3);
                                int iPrepareNextCertH1 = RFC3280CertPathUtilities.prepareNextCertH1(certPath, i8, i6);
                                int iPrepareNextCertH2 = RFC3280CertPathUtilities.prepareNextCertH2(certPath, i8, iPrepareNextCertI2);
                                int iPrepareNextCertH3 = RFC3280CertPathUtilities.prepareNextCertH3(certPath, i8, i9);
                                int iPrepareNextCertI1 = RFC3280CertPathUtilities.prepareNextCertI1(certPath, i8, iPrepareNextCertH1);
                                iPrepareNextCertI2 = RFC3280CertPathUtilities.prepareNextCertI2(certPath, i8, iPrepareNextCertH2);
                                int iPrepareNextCertJ = RFC3280CertPathUtilities.prepareNextCertJ(certPath, i8, iPrepareNextCertH3);
                                RFC3280CertPathUtilities.prepareNextCertK(certPath, i8);
                                iPrepareNextCertM = RFC3280CertPathUtilities.prepareNextCertM(certPath, i8, RFC3280CertPathUtilities.prepareNextCertL(certPath, i8, iPrepareNextCertM));
                                RFC3280CertPathUtilities.prepareNextCertN(certPath, i8);
                                ...
                                RFC3280CertPathUtilities.prepareNextCertO(certPath, i8, hashSet2, certPathCheckers);
                                subjectPrincipal = PrincipalUtils.getSubjectPrincipal(x509Certificate3);
                                try {
                                    try {
                                        PublicKey nextWorkingKey = CertPathValidatorUtilities.getNextWorkingKey(certPath.getCertificates(), i8, this.helper);
                                        ...
                                        e = e2;
                                        throw new CertPathValidatorException("Next working key could not be retrieved.", e, certPath, i8);
                                    }
                            ...
                            pKIXPolicyNodePrepareCertB = pKIXPolicyNodeProcessCertE;
                            i5 = i9;
                    ...
                    int i10 = size2;
                    int i11 = i10 + 1;
                    int iWrapupCertB = RFC3280CertPathUtilities.wrapupCertB(certPath, i11, RFC3280CertPathUtilities.wrapupCertA(i6, x509Certificate2));
                    ...
                    RFC3280CertPathUtilities.wrapupCertF(certPath, i11, certPathCheckers, hashSet);
                    PKIXPolicyNode pKIXPolicyNodeWrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, pKIXExtendedParameters3, initialPolicies, i11, arrayListArr3, pKIXPolicyNode3, hashSet4);
