...
class RFC3280CertPathUtilities {
    ...
    protected static Set processCRLF(X509CRL x509crl, Object obj, X509Certificate x509Certificate, PublicKey publicKey, PKIXExtendedParameters pKIXExtendedParameters, List list, JcaJceHelper jcaJceHelper) throws IOException, AnnotatedException {
        int i;
    ...
    protected static PublicKey processCRLG(X509CRL x509crl, Set set) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException, AnnotatedException, NoSuchProviderException {
    ...
    protected static X509CRL processCRLH(Set set, PublicKey publicKey) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException, AnnotatedException, NoSuchProviderException {
        Iterator it = set.iterator();
        Exception e = null;
        while (it.hasNext()) {
    ...
    protected static Set[] processCRLA1ii(Date date, PKIXExtendedParameters pKIXExtendedParameters, X509Certificate x509Certificate, X509CRL x509crl) throws IOException, AnnotatedException {
        HashSet hashSet = new HashSet();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x00c6, code lost:
        ...
        if ("2.5.29.32.0".equals(r6.getValidPolicy()) == false) goto L112;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x00da, code lost:
        ...
        r8 = org.spongycastle.asn1.x509.PolicyInformation.getInstance(r5.nextElement());
     */
    /* JADX WARN: Code restructure failed: missing block: B:35:0x00ee, code lost:
    
        if ("2.5.29.32.0".equals(r8.getPolicyIdentifier().getId()) == false) goto L114;
     */
    /* JADX WARN: Code restructure failed: missing block: B:36:0x00f0, code lost:
    
        r5 = org.spongycastle.jce.provider.CertPathValidatorUtilities.getQualifierSet(r8.getPolicyQualifiers());
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x0101, code lost:
        ...
        throw new org.spongycastle.jce.exception.ExtCertPathValidatorException("Policy qualifier info set could not be decoded.", r0, r16, r17);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:49:0x0120, code lost:
        ...
        r5 = (org.spongycastle.jce.provider.PKIXPolicyNode) r6.getParent();
     */
    /* JADX WARN: Code restructure failed: missing block: B:50:0x012e, code lost:
    
        if ("2.5.29.32.0".equals(r5.getValidPolicy()) == false) goto L101;
     */
    /* JADX WARN: Code restructure failed: missing block: B:51:0x0130, code lost:
    
        r5 = new org.spongycastle.jce.provider.PKIXPolicyNode(new java.util.ArrayList(), r7, (java.util.Set) r13.get(r11), r5, r10, r11, r12);
        r5.addChild(r5);
        r18[r7].add(r5);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x0153, code lost:
        ...
        throw new org.spongycastle.jce.exception.ExtCertPathValidatorException("Certificate policies extension could not be decoded.", r0, r16, r17);
     */
    /*
        ...
        try {
            ...
            for (int i6 = i4 - 1; i6 >= 0; i6--) {
                ...
                while (i3 < list2.size()) {
                    ...
                    i3 = (pKIXPolicyNode4.hasChildren() || (pKIXPolicyNode = CertPathValidatorUtilities.removePolicyNode(pKIXPolicyNode, listArr, pKIXPolicyNode4)) != null) ? i3 + 1 : 0;
                }
            }
