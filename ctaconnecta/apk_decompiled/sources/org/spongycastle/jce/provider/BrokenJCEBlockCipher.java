...
public class BrokenJCEBlockCipher implements BrokenPBE {
    ...
    /* JADX WARN: Removed duplicated region for block: B:24:0x0092 A[PHI: r0
      0x0092: PHI (r0v2 org.spongycastle.crypto.CipherParameters) = 
      (r0v1 org.spongycastle.crypto.CipherParameters)
      (r0v1 org.spongycastle.crypto.CipherParameters)
      (r0v3 org.spongycastle.crypto.CipherParameters)
      (r0v3 org.spongycastle.crypto.CipherParameters)
     binds: [B:30:0x00b4, B:32:0x00b8, B:20:0x007d, B:22:0x0081] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
        ...
        if (key instanceof BCPBEKey) {
            ...
            if (algorithmParameterSpec == null) {
                ...
                if (rC2ParameterSpec.getIV() == null || this.ivLength == 0) {
                    ...
                    ParametersWithIV parametersWithIV2 = new ParametersWithIV(rC5Parameters, rC2ParameterSpec.getIV());
        ...
        if (this.ivLength != 0) {
            ...
            if (!z) {
                ...
                if (i == 1 || i == 3) {
                    ...
                    ParametersWithIV parametersWithIV4 = new ParametersWithIV(cipherParameters, bArr);
    ...
    protected int engineDoFinal(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, BadPaddingException, IllegalBlockSizeException, DataLengthException {
        byte[] bArr3;
        int i4;
        int iProcessBytes;
        if (i2 != 0) {
