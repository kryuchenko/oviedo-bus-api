...
public class TlsDHUtils {
    ...
    public static boolean areCompatibleParameters(DHParameters dHParameters, DHParameters dHParameters2) {
        if (dHParameters.getP().equals(dHParameters2.getP()) && dHParameters.getG().equals(dHParameters2.getG())) {
            return dHParameters.getQ() == null || dHParameters2.getQ() == null || dHParameters.getQ().equals(dHParameters2.getQ());
        }
        return false;
    }
