...
public class KCCMBlockCipher implements AEADBlockCipher {
    ...
    public int processPacket(byte[] bArr, int i, int i2, byte[] bArr2, int i3) throws IllegalStateException, InvalidCipherTextException, DataLengthException {
        ...
        if (this.forEncryption) {
            ...
            int blockSize3 = i3;
            while (blockSize2 > 0) {
                ProcessBlock(bArr, blockSize, i2, bArr2, blockSize3);
            ...
            while (true) {
                int i7 = this.macSize;
                if (i6 < i7) {
                    bArr2[blockSize3 + i6] = (byte) (this.buffer[i6] ^ this.macBlock[i6]);
                    i6++;
                } else {
            ...
            this.engine.processBlock(this.nonce, 0, this.s, 0);
            int blockSize4 = i2 / this.engine.getBlockSize();
            int blockSize5 = i;
            int blockSize6 = i3;
            for (int i8 = 0; i8 < blockSize4; i8++) {
                ProcessBlock(bArr, blockSize5, i2, bArr2, blockSize6);
            ...
            if (i2 > blockSize5) {
                ...
                while (true) {
                    ...
                    bArr2[blockSize6 + i10] = (byte) (this.buffer[i10] ^ bArr[blockSize5 + i10]);
                    i10++;
                }
                blockSize6 += i4;
            }
            ...
            System.arraycopy(bArr2, blockSize6 - i12, this.buffer, 0, i12);
            CalculateMac(bArr2, 0, blockSize6 - this.macSize);
    ...
    private byte getFlag(boolean z, int i) {
        ...
        while (binaryString.length() < 4) {
            binaryString = new StringBuffer(binaryString).insert(0, StdEntropyCoder.DEF_THREADS_NUM).toString();
        }
