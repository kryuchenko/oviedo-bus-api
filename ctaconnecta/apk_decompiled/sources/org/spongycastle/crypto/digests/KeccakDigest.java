...
public class KeccakDigest implements ExtendedDigest {
    ...
    private void padAndSwitchToSqueezingPhase() {
        ...
        if (i6 > 0) {
            ...
            jArr2[i5] = jArr2[i5] ^ (j & Pack.littleEndianToLong(this.dataQueue, i7));
        }
    ...
    private static void theta(long[] jArr) {
        ...
        jArr[21] = jArr[21] ^ jLeftRotate2;
        long jLeftRotate3 = j2 ^ leftRotate(j4, 1);
        ...
        long jLeftRotate4 = j3 ^ leftRotate(j5, 1);
