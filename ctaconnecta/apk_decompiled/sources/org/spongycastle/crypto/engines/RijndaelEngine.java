...
public class RijndaelEngine implements BlockCipher {
    ...
    private static final int[] rcon = {1, 2, 4, 8, 16, 32, 64, 128, 27, 54, 108, 216, CipherSuite.TLS_DHE_PSK_WITH_AES_256_GCM_SHA384, 77, CipherSuite.TLS_DHE_RSA_WITH_SEED_CBC_SHA, 47, 94, 188, 99, 198, 151, 53, 106, 212, CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA384, 125, ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION, 239, CipherSuite.TLS_DH_anon_WITH_CAMELLIA_256_CBC_SHA256, CipherSuite.TLS_DHE_PSK_WITH_AES_256_CBC_SHA};
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            jMul0xe4 = (((((mul0xe(i6) ^ mul0xb(i7)) ^ mul0xd(i8)) ^ mul0x9(i9)) & 255) << i) | jMul0xe4;
        }
        this.A0 = jMul0xe;
        this.A1 = jMul0xe2;
        this.A2 = jMul0xe3;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        int i6 = 0;
        int i7 = 0;
        for (int i8 = 1; i6 < i && i7 < (this.ROUNDS + i8) * (this.BC / i2); i8 = 1) {
            for (int i9 = 0; i9 < 4; i9++) {
                int i10 = this.BC;
                long[] jArr2 = jArr[i7 / (i10 / 8)];
                jArr2[i9] = ((bArr2[i9][i6] & 255) << ((i7 * 8) % i10)) | jArr2[i9];
            }
            i6++;
            i7++;
            i2 = 8;
        ...
        int i11 = 0;
        while (i7 < (this.ROUNDS + 1) * (this.BC / 8)) {
            int i12 = 0;
            while (i12 < i3) {
                byte[] bArr3 = bArr2[i12];
                i12++;
                bArr3[0] = (byte) (bArr3[0] ^ S[bArr2[i12 % 4][i - 1] & 255]);
            }
            byte[] bArr4 = bArr2[0];
            int i13 = i11 + 1;
            bArr4[0] = (byte) (rcon[i11] ^ bArr4[0]);
            if (i <= 6) {
                ...
                for (int i18 = 0; i18 < i3; i18++) {
                    ...
                    bArr7[i3] = (byte) (bArr7[i3] ^ S[bArr7[3] & 255]);
                }
            ...
            int i21 = 0;
            while (i21 < i && i7 < (this.ROUNDS + 1) * (this.BC / 8)) {
                int i22 = 0;
                while (i22 < i3) {
                    int i23 = this.BC;
                    long[] jArr3 = jArr[i7 / (i23 / 8)];
                    jArr3[i22] = ((bArr2[i22][i21] & 255) << ((i7 * 8) % i23)) | jArr3[i22];
                    i22++;
                    i = i;
                    i3 = 4;
                }
