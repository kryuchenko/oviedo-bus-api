...
public class ASN1GeneralizedTime extends ASN1Primitive {
    ...
    private String convert(int i) {
        if (i < 10) {
            return StdEntropyCoder.DEF_THREADS_NUM + i;
        }
    ...
    public Date getDate() throws ParseException {
        ...
        if (hasFractionalSeconds()) {
            ...
            if (i2 > 3) {
                ...
                strFromByteArray = strFromByteArray.substring(0, 14) + (strSubstring.substring(0, i) + StdEntropyCoder.DEF_THREADS_NUM + strSubstring.substring(i));
            }
        }
