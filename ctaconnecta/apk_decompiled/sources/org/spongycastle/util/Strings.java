    ...
    public static String fromUTF8ByteArray(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            if ((b & 240) == 240) {
                ...
                i2 = (b & ISO7816.INS_CREATE_FILE) == 224 ? i2 + 3 : (b & ISO7816.INS_GET_RESPONSE) == 192 ? i2 + 2 : i2 + 1;
                i3 = i4;
            }
        }
        ...
        while (i < bArr.length) {
            ...
            if ((b2 & 240) == 240) {
                ...
                i += 4;
                i5++;
            } else if ((b2 & ISO7816.INS_CREATE_FILE) == 224) {
                c = (char) (((b2 & 15) << 12) | ((bArr[i + 1] & Utf8.REPLACEMENT_BYTE) << 6) | (bArr[i + 2] & Utf8.REPLACEMENT_BYTE));
                i += 3;
            } else if ((b2 & ISO7816.INS_WRITE_BINARY) == 208 || (b2 & ISO7816.INS_GET_RESPONSE) == 192) {
                int i7 = (b2 & Ascii.US) << 6;
                byte b3 = bArr[i + 1];
