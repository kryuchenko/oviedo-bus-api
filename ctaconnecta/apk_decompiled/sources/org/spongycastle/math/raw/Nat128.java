...
public abstract class Nat128 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 4; i < i3; i3 = 4) {
            ...
            int i4 = i + 1;
            long j13 = j;
            long j14 = (j12 >>> 32) + (j11 * j3) + (iArr3[i4] & j13);
            iArr3[i4] = (int) j14;
            long j15 = (j14 >>> 32) + (j11 * j4) + (iArr3[r8] & j13);
            iArr3[i + 2] = (int) j15;
            long j16 = (j15 >>> 32) + (j11 * j5) + (iArr3[r8] & j13);
            iArr3[i + 3] = (int) j16;
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i5 < 4) {
            ...
            iArr3[i6] = (int) j11;
            long j12 = j;
            long j13 = (j11 >>> 32) + (j10 * j2) + (iArr3[r15] & 4294967295L);
            iArr3[i4 + 2] = (int) j13;
            long j14 = (j13 >>> 32) + (j10 * j3) + (iArr3[r15] & 4294967295L);
            iArr3[i4 + 3] = (int) j14;
            long j15 = (j14 >>> 32) + (j10 * j4) + (iArr3[r13] & 4294967295L);
            iArr3[i4 + 4] = (int) j15;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 4) {
            ...
            iArr3[i3 + 3] = (int) j12;
            long j13 = (j12 >>> 32) + j6 + (iArr3[r2] & j8);
            iArr3[i3 + 4] = (int) j13;
            j6 = j13 >>> 32;
            i = i2;
            j = j8;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (true) {
            ...
            iArr3[i5 + 3] = (int) j13;
            long j14 = (j13 >>> 32) + j6 + (iArr3[r10] & j7);
            iArr3[i5 + 4] = (int) j14;
            j6 = j14 >>> 32;
            i4++;
            j = j7;
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                int i11 = (int) j19;
                iArr2[6] = i10 | (i11 << 1);
                iArr2[7] = (i11 >>> 31) | ((iArr2[7] + ((int) (j19 >>> 32))) << 1);
                return;
            }
            i2 = i4;
        }
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i15 = i14 >>> 31;
                int i16 = i2 + 7;
                iArr2[i16] = i15 | ((iArr2[i16] + ((int) (j20 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
