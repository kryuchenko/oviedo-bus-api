...
public abstract class Nat {
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i2 < i) {
            ...
            int[] iArr4 = iArr2;
            int[] iArr5 = iArr3;
            long jMulWordAddTo = (mulWordAddTo(i3, iArr[i2], iArr4, 0, iArr5, i2) & 4294967295L) + j + (4294967295L & iArr5[r12]);
            iArr5[i2 + i3] = (int) jMulWordAddTo;
            j = jMulWordAddTo >>> 32;
            i2++;
            i = i3;
            iArr2 = iArr4;
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            long jMulWordAddTo = (mulWordAddTo(i, iArr[i2 + i6], iArr2, i3, iArr3, i5) & 4294967295L) + j + (4294967295L & iArr3[r7]);
            iArr3[i5 + i] = (int) jMulWordAddTo;
            j = jMulWordAddTo >>> 32;
            i5++;
        }
        return (int) j;
