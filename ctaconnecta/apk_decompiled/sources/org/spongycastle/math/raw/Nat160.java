...
public abstract class Nat160 {
    ...
    public static void mul(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i2 < i) {
            ...
            long j13 = (j12 * j) + (iArr3[i2] & 4294967295L);
            iArr3[i2] = (int) j13;
            int i3 = i2 + 1;
            long j14 = (j13 >>> c) + (j12 * j2) + (iArr3[i3] & 4294967295L);
            iArr3[i3] = (int) j14;
            long j15 = j5;
            long j16 = (j14 >>> 32) + (j12 * j3) + (iArr3[r8] & 4294967295L);
            iArr3[i2 + 2] = (int) j16;
            long j17 = (j16 >>> 32) + (j12 * j4) + (iArr3[r6] & 4294967295L);
            iArr3[i2 + 3] = (int) j17;
            long j18 = (j17 >>> 32) + (j12 * j15) + (iArr3[r2] & 4294967295L);
            iArr3[i2 + 4] = (int) j18;
            iArr3[i2 + 5] = (int) (j18 >>> 32);
            i2 = i3;
            j5 = j15;
            i = 5;
            c = ' ';
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 5) {
            ...
            iArr3[i2 + 4] = (int) j14;
            long j15 = (j14 >>> 32) + j7 + (iArr3[r2] & j8);
            iArr3[i2 + 5] = (int) j15;
            j7 = j15 >>> 32;
            j = j8;
            j2 = j2;
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i4 < 5) {
            ...
            iArr3[i5 + 4] = (int) j16;
            long j17 = (j16 >>> 32) + j6 + (iArr3[r12] & 4294967295L);
            iArr3[i5 + 5] = (int) j17;
            j6 = j17 >>> 32;
            i4++;
            i5 = i6;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i19 = i18 >>> 31;
                int i20 = i2 + 9;
                iArr2[i20] = i19 | ((iArr2[i20] + ((int) (j29 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
