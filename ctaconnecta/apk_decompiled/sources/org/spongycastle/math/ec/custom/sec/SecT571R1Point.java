...
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (secT571FieldElement5.isZero()) {
            ...
            secT571FieldElement3 = (SecT571FieldElement) eCFieldElementDivide.square().add(eCFieldElementDivide).add(secT571FieldElement10).addOne();
        ...
        return new SecT571R1Point(curve, secT571FieldElement3, secT571FieldElement2, eCFieldElementArr, this.withCompression);
    }
    ...
    public ECPoint twice() {
        ...
        if (jArrPrecompMultiplicand != null) {
            SecT571Field.multiply(secT571FieldElement5.x, jArr4, secT571FieldElement5.x);
        }
        if (jArrPrecompMultiplicand == null) {
