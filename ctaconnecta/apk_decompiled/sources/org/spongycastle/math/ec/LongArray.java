...
class LongArray implements Cloneable {
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        while (i9 < 16) {
            ...
            if ((i9 & 1) == 0) {
                int i12 = i7;
                jArr = jArr3;
                shiftUp(jArr, i11 >>> 1, jArr3, i11, i12, 1);
                i7 = i12;
            } else {
                int i13 = i7;
                jArr = jArr3;
                add(jArr, i7, jArr3, i11 - i13, jArr, i11, i13);
                i11 = i11;
            }
            i9++;
            jArr3 = jArr;
        ...
        while (i14 >= 0) {
            ...
            while (i15 < i4) {
                ...
                int i17 = i7;
                addBoth(jArr6, i15 - 1, jArr3, iArr3[i16 & 15], jArr4, iArr3[(i16 >>> 4) & 15], i17);
                i15 += 2;
                i7 = i17;
                iArr2 = iArr3;
                jArr6 = jArr6;
        ...
        for (int i19 = 56; i19 >= 0; i19 -= 8) {
            for (int i20 = 0; i20 < i4; i20 += 2) {
                int i21 = (int) (jArr5[i20] >>> i19);
                long[] jArr10 = jArr9;
                addBoth(jArr8, i20, jArr10, iArr4[i21 & 15], jArr4, iArr4[(i21 >>> 4) & 15], i18);
                jArr9 = jArr10;
            }
            if (i19 > 0) {
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        int i13 = i7 + i12;
        iArr2[1] = i13;
        for (int i14 = 2; i14 < 16; i14++) {
            i13 += i9;
            iArr2[i14] = i13;
        }
        int i15 = i7;
        long[] jArr4 = new long[i13 + i9 + 1];
        interleave(longArray2.m_ints, 0, jArr4, 0, i15, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr4, i15, i8);
        int i16 = i15;
        int i17 = 1;
        while (i17 < 8) {
            int i18 = i16 + i11;
            int i19 = i15;
            shiftUp(jArr4, i19, jArr4, i18, i11, i17);
            i15 = i19;
            i17++;
            i16 = i18;
        }
        ...
        while (true) {
            ...
            while (true) {
                i4 = i20;
                int i23 = i15;
                long j2 = jArr4[i22] >>> i21;
                int i24 = 0;
                while (true) {
                    int i25 = ((int) j2) & i4;
                    if (i25 != 0) {
                        add(jArr4, iArr2[i25] + i22, jArr4, i23, i11);
                    }
                    int i26 = i24 + 1;
                    if (i26 == 8) {
                        break;
        ...
        while (true) {
            int i28 = i27 - 1;
            if (i28 <= i10) {
                return reduceResult(jArr4, iArr2[1], i9, i, iArr);
            }
            if ((i28 & 1) == 0) {
                int i29 = i9;
                jArr2 = jArr4;
                ...
                jArr2 = jArr4;
                i6 = i9;
                distribute(jArr2, iArr2[i28], iArr2[i27 - 2], iArr2[1], i6);
            }
            i27 = i28;
            i9 = i6;
            jArr4 = jArr2;
