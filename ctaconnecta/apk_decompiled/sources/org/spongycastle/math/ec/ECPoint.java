...
public abstract class ECPoint {
    ...
    public static class Fp extends AbstractFp {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 2 || coordinateSystem == 4) {
                ...
                if (!zIsOne3 && eCFieldElement5.equals(eCFieldElement6)) {
                    ...
                    ECFieldElement eCFieldElementSquare2 = eCFieldElementSubtract7.square();
                    ...
                    eCFieldElementMultiply = eCFieldElementSubtract7.multiply(eCFieldElement5);
                    ...
                    if (!zIsOne3) {
                        ...
                        eCFieldElementMultiply5 = eCFieldElementSquare3.multiply(eCFieldElement5).multiply(eCFieldElementMultiply5);
                    }
                    ...
                    if (zIsOne4) {
                        ...
                        c = 0;
                        ECFieldElement eCFieldElementSquare4 = eCFieldElement6.square();
                        eCFieldElementMultiply2 = eCFieldElementSquare4.multiply(eCFieldElementMultiply2);
                        eCFieldElementMultiply3 = eCFieldElementSquare4.multiply(eCFieldElement6).multiply(eCFieldElementMultiply3);
                    }
                    ...
                    ECFieldElement eCFieldElementMultiply12 = eCFieldElementSquare5.multiply(eCFieldElementSubtract11);
                    ...
                    ECFieldElement eCFieldElementMultiply14 = !zIsOne3 ? eCFieldElementSubtract11.multiply(eCFieldElement5) : eCFieldElementSubtract11;
                    eCFieldElementMultiply = !zIsOne4 ? eCFieldElementMultiply14.multiply(eCFieldElement6) : eCFieldElementMultiply14;
                    eCFieldElement = eCFieldElementMultiplyMinusProduct;
                    eCFieldElement2 = eCFieldElementSubtract13;
                    eCFieldElement3 = eCFieldElementMultiply == eCFieldElementSubtract11 ? eCFieldElementSquare5 : null;
                }
                if (coordinateSystem == 4) {
                    ...
                    eCFieldElementArr[c2] = eCFieldElementCalculateJacobianModifiedW;
                } else {
                    eCFieldElementArr = new ECFieldElement[1];
                    eCFieldElementArr[c] = eCFieldElementMultiply;
                }
        ...
        public ECPoint timesPow2(int i) {
            ...
            if (coordinateSystem == 4) {
                return new Fp(curve, eCFieldElementMultiply, eCFieldElementSubtract, new ECFieldElement[]{eCFieldElementFromBigInteger, a}, this.withCompression);
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 6) {
                ...
                return new F2m(curve, eCFieldElementAdd2, eCFieldElementAdd, new ECFieldElement[]{eCFieldElementFromBigInteger}, this.withCompression);
            }
            throw new IllegalStateException("unsupported coordinate system");
        }
