    ...
    public GMSSPrivateKeyParameters(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, GMSSDigestProvider gMSSDigestProvider) {
        ...
        if (bArr5 == null) {
            ...
            for (int i3 = 0; i3 < this.numLayer; i3++) {
                this.keep[i3] = (byte[][]) Array.newInstance((Class<?>) Byte.TYPE, (int) Math.floor(this.heightOfTrees[i3] / 2), this.mdLength);
            }
            i = 1;
        } else {
            i = 1;
        ...
        if (gMSSRootCalcArr == null) {
            ...
            int i6 = 0;
            while (i6 < this.numLayer - 1) {
                int i7 = i6 + 1;
                this.nextNextRoot[i6] = new GMSSRootCalc(this.heightOfTrees[i7], this.K[i7], this.digestProvider);
                i6 = i7;
            }
        } else {
        ...
        for (int i8 = 0; i8 < this.numLayer; i8++) {
            this.numLeafs[i8] = i << this.heightOfTrees[i8];
        }
        ...
        if (i9 <= 1) {
            ...
            this.nextNextLeaf = new GMSSLeaf[i9 - 2];
            int i10 = 0;
        ...
        if (gMSSLeafArr2 == null) {
            ...
            int i12 = 0;
            while (i12 < this.numLayer - 1) {
                int i13 = i12 + 1;
                this.upperLeaf[i12] = new GMSSLeaf(gMSSDigestProvider.get(), this.otsIndex[i12], this.numLeafs[i13], this.currentSeeds[i12]);
                i12 = i13;
            }
        } else {
        ...
        if (gMSSLeafArr3 == null) {
            ...
            while (i14 < this.numLayer - 1) {
                int i15 = i14 + 1;
                this.upperTreehashLeaf[i14] = new GMSSLeaf(gMSSDigestProvider.get(), this.otsIndex[i14], this.numLeafs[i15]);
                i14 = i15;
            }
        } else {
        ...
        while (i18 < this.numLayer - 1) {
            System.arraycopy(bArr[i18], 0, bArr8, 0, this.mdLength);
            this.gmssRandom.nextSeed(bArr8);
            byte[] bArrNextSeed = this.gmssRandom.nextSeed(bArr8);
            int i19 = i18 + 1;
            this.nextRootSig[i18] = new GMSSRootSig(gMSSDigestProvider.get(), this.otsIndex[i18], this.heightOfTrees[i19]);
            this.nextRootSig[i18].initSign(bArrNextSeed, bArr6[i18]);
            i18 = i19;
        }
    }
