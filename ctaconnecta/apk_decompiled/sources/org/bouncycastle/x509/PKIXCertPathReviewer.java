...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:75:0x017e, code lost:
        ...
        if ((r9 instanceof org.bouncycastle.asn1.ASN1ObjectIdentifier) == false) goto L382;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:81:0x01a2, code lost:
        ...
        if (r9.equals(((org.bouncycastle.jce.provider.PKIXPolicyNode) r10.next()).getValidPolicy()) == false) goto L386;
     */
    ...
    */
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(13:56|(4:167|58|59|63)(2:64|(3:163|66|63)(2:70|(2:77|78)(3:74|(1:76)(0)|78)))|(2:180|79)|84|(19:169|86|(1:88)(1:91)|171|92|(1:94)(1:97)|98|(2:101|99)|185|102|(2:105|103)|165|106|107|155|108|109|157|110)(1:119)|(1:124)(1:123)|125|(7:127|(1:131)|173|132|(2:134|(1:136))(1:137)|140|(1:144))|145|161|146|184|149) */
    ...
    /* JADX WARN: Removed duplicated region for block: B:169:0x0292 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    */
        ...
        if (trustAnchors.size() > 1) {
            ...
            if (!trustAnchors.isEmpty()) {
                ...
                if (trustAnchor2 == null) {
                    ...
                    try {
                        subjectX500Principal = trustedCert2 != null ? getSubjectPrincipal(trustedCert2) : new X500Principal(trustAnchor2.getCAName());
                ...
                while (size >= 0) {
                    ...
                    try {
                        ...
                        objArr3[c] = new TrustedInput(x509Certificate4.getNotAfter());
                        errorBundle2 = new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.certificateExpired", objArr3);
                        ...
                        objArr4[c] = new TrustedInput(x509Certificate4.getNotBefore());
                    ...
                    if (this.pkixParams.isRevocationEnabled()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            objArr5[c] = new UntrustedUrlInput(it.next());
                            addNotification(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.crlDistPoint", objArr5), size);
                        }
                        Iterator it2 = oCSPUrls.iterator();
                        while (it2.hasNext()) {
                            Object[] objArr6 = new Object[1];
                            objArr6[c] = new UntrustedUrlInput(it2.next());
                            addNotification(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.ocspLocation", objArr6), size);
                        }
                        try {
                            i = i2;
                    ...
                    if (x500Principal == null && !x509Certificate.getIssuerX500Principal().equals(x500Principal)) {
                        ...
                        objArr7[c] = name3;
                        objArr7[1] = name4;
                        addError(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.certWrongIssuer", objArr7), size);
                    }
                    if (i != this.n) {
        ...
        try {
            ...
            while (i2 < aSN1Sequence2.size()) {
                ...
                if (QCStatement.id_etsi_qcs_QcCompliance.equals((ASN1Primitive) qCStatement.getStatementId())) {
                    ...
                    } else if (QCStatement.id_etsi_qcs_QcSSCD.equals((ASN1Primitive) qCStatement.getStatementId())) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:195:0x048a A[RETURN] */
                    ...
                    if (crl == null) {
                        ...
                        if (crl.getNextUpdate() != null && !this.pkixParams.getDate().before(crl.getNextUpdate())) {
                            ...
                            try {
                                ...
                                objArr5[c] = trustedInput7;
                                objArr5[c3] = trustedInput8;
                                objArr5[2] = untrustedUrlInput2;
                                addNotification(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.onlineInvalidCRL", objArr5), i);
                                z2 = z3;
                            } catch (CertPathReviewerException e7) {
                                e = e7;
                                z2 = z3;
                        ...
                        try {
                            ...
                            objArr6[c] = trustedInput;
                            objArr6[c3] = trustedInput2;
                            objArr6[2] = untrustedUrlInput;
                            addNotification(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.onlineValidCRL", objArr6), i);
                            x509crl = crl;
                            z = true;
                            break;
                        ...
                        try {
                            ...
                            objArr7[c] = untrustedInput;
                            objArr7[c3] = untrustedInput2;
                            objArr7[2] = untrustedUrlInput3;
                            addNotification(new ErrorBundle(RESOURCE_NAME, "CertPathReviewer.onlineCRLWrongCA", objArr7), i);
