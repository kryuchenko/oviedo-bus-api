...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchB, new ECDomainParameters(eCCurveConfigureCurve4, configureBasepoint(eCCurveConfigureCurve4, new BigInteger(StdEntropyCoder.DEF_THREADS_NUM), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger8, ECConstants.ONE));
        ...
        hashtable2.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_C, new ECDomainParameters(eCCurveConfigureCurve5, configureBasepoint(eCCurveConfigureCurve5, new BigInteger(StdEntropyCoder.DEF_THREADS_NUM), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger10, ECConstants.ONE));
