...
public class ServiceType extends ASN1Object {
    ...
    public String toString() {
        ...
        sb.append(iIntValueExact == CPD.value.intValueExact() ? "(CPD)" : iIntValueExact == VSD.value.intValueExact() ? "(VSD)" : iIntValueExact == VPKC.value.intValueExact() ? "(VPKC)" : iIntValueExact == CCPD.value.intValueExact() ? "(CCPD)" : "?");
        return sb.toString();
    }
}
