...
public class TLSKDF {
    ...
    public static class TLS12 extends TLSKeyMaterialFactory {
        ...
        private byte[] PRF(TLSKeyMaterialSpec tLSKeyMaterialSpec, Mac mac) throws IllegalStateException, DataLengthException, IllegalArgumentException, CloneNotSupportedException {
    ...
    public static byte[] PRF_legacy(TLSKeyMaterialSpec tLSKeyMaterialSpec) throws IllegalStateException, DataLengthException, IllegalArgumentException, CloneNotSupportedException {
