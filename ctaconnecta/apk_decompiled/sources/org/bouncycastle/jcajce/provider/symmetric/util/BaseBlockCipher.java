...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARN: Removed duplicated region for block: B:35:0x00b0 A[PHI: r8
      0x00b0: PHI (r8v29 org.bouncycastle.crypto.CipherParameters) = 
     ...
     binds: [B:104:0x020a, B:60:0x014b, B:49:0x00fb, B:34:0x00ae] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Type inference failed for: r2v76, types: [org.bouncycastle.crypto.params.ParametersWithIV] */
    /* JADX WARN: Type inference failed for: r8v11 */
    /* JADX WARN: Type inference failed for: r8v18 */
    /* JADX WARN: Type inference failed for: r8v19 */
    /* JADX WARN: Type inference failed for: r8v20, types: [org.bouncycastle.crypto.params.ParametersWithIV] */
    /* JADX WARN: Type inference failed for: r8v22, types: [org.bouncycastle.crypto.CipherParameters] */
    /* JADX WARN: Type inference failed for: r8v27, types: [org.bouncycastle.crypto.params.AEADParameters] */
    ...
    */
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws NoSuchMethodException, InvalidKeyException, SecurityException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof AEADParameterSpec) {
            ...
            parametersWithIV = new AEADParameters(parametersWithIV instanceof ParametersWithIV ? (KeyParameter) ((ParametersWithIV) parametersWithIV).getParameters() : parametersWithIV, aEADParameterSpec.getMacSizeInBits(), aEADParameterSpec.getNonce(), aEADParameterSpec.getAssociatedData());
            ...
            if (gOST28147ParameterSpec.getIV() != null && this.ivLength != 0) {
                parametersWithIV2 = rC5Parameters instanceof ParametersWithIV ? new ParametersWithIV(((ParametersWithIV) rC5Parameters).getParameters(), gOST28147ParameterSpec.getIV()) : new ParametersWithIV(rC5Parameters, gOST28147ParameterSpec.getIV());
                this.ivParam = parametersWithIV2;
                parametersWithIV = parametersWithIV2;
            }
            ...
            if (rC2ParameterSpec.getIV() != null && this.ivLength != 0) {
                parametersWithIV2 = rC5Parameters instanceof ParametersWithIV ? new ParametersWithIV(((ParametersWithIV) rC5Parameters).getParameters(), rC2ParameterSpec.getIV()) : new ParametersWithIV(rC5Parameters, rC2ParameterSpec.getIV());
                this.ivParam = parametersWithIV2;
                parametersWithIV = parametersWithIV2;
            }
            parametersWithIV = rC5Parameters;
            ...
            if (cls == null || !cls.isInstance(algorithmParameterSpec)) {
                ...
                try {
                    ...
                    Method declaredMethod2 = cls.getDeclaredMethod("getIV", null);
                    boolean z6 = parametersWithIV instanceof ParametersWithIV;
                    Object parameters = parametersWithIV;
                    if (z6) {
                        parameters = ((ParametersWithIV) parametersWithIV).getParameters();
                    }
                    AEADParameters aEADParameters = new AEADParameters((KeyParameter) parameters, ((Integer) declaredMethod.invoke(algorithmParameterSpec, null)).intValue(), (byte[]) declaredMethod2.invoke(algorithmParameterSpec, null));
        ...
        ParametersWithRandom parametersWithRandom = parametersWithIV;
        if (this.ivLength != 0) {
