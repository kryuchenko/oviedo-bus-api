                ...
                try {
                    ...
                    while (size2 >= 0) {
                        ...
                        try {
                            ...
                            RFC3280CertPathUtilities.processCertBC(certPath, i8, pKIXNameConstraintValidator3, this.isForCRLCheck);
                            HashSet hashSet5 = hashSet4;
                            int i9 = i5;
                            PKIXPolicyNode pKIXPolicyNodeProcessCertE = RFC3280CertPathUtilities.processCertE(certPath, i8, RFC3280CertPathUtilities.processCertD(certPath, i8, hashSet5, pKIXPolicyNode2, arrayListArr2, i9, this.isForCRLCheck));
                            ...
                            if (i7 != size) {
                                ...
                                PKIXPolicyNode pKIXPolicyNodePrepareCertB = RFC3280CertPathUtilities.prepareCertB(certPath, i8, arrayListArr2, pKIXPolicyNodeProcessCertE, iPrepareNextCertI2);
                                ...
                                list2 = list4;
                                RFC3280CertPathUtilities.prepareNextCertO(certPath, i8, hashSet2, list2);
                                ...
                                try {
                                    ...
                                    throw new CertPathValidatorException("Next working key could not be retrieved.", e2, certPath, i8);
                                }
                            } else {
                                hashSet4 = hashSet5;
                            }
                    ...
                    RFC3280CertPathUtilities.wrapupCertF(certPath, i11, list5, hashSet);
                    PKIXPolicyNode pKIXPolicyNodeWrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, pKIXExtendedParameters2, initialPolicies, i11, arrayListArr3, pKIXPolicyNode3, hashSet4);
