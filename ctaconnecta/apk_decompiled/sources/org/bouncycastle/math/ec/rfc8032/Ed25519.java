...
public abstract class Ed25519 {
    ...
    private static final int[] L = {1559614445, 1477600026, -1560830762, 350157278, 0, 0, 0, DriveFile.MODE_READ_ONLY};
    ...
    private static boolean decodePointVar(byte[] bArr, int i, boolean z, PointAffine pointAffine) {
        ...
        int i2 = (b & 128) >>> 7;
        bArrCopyOfRange[31] = (byte) (b & Byte.MAX_VALUE);
    ...
    private static byte[] reduceScalar(byte[] bArr) {
        ...
        long jDecode323 = (decode32(bArr, 28) & 4294967295L) - (jDecode24 * (-50998291));
        long jDecode242 = (((decode24(bArr, 32) << 4) & 4294967295L) - (j2 * (-50998291))) - (jDecode24 * 19280294);
        long jDecode324 = ((decode32(bArr, 42) & 4294967295L) - (j2 * (-6428113))) - (jDecode24 * 5343);
        ...
        long jDecode325 = ((((decode32(bArr, 35) & 4294967295L) - (j2 * 19280294)) - (jDecode24 * 127719000)) - (j3 * (-6428113))) - (jDecode244 * 5343);
        long j5 = ((jDecode242 - (j3 * 127719000)) - (jDecode244 * (-6428113))) - (j4 * 5343);
        long jDecode245 = (((decode24(bArr, 46) << 4) & 4294967295L) - (j2 * 5343)) + (jDecode324 >> 28);
        long jDecode326 = (decode32(bArr, 14) & 4294967295L) - (jDecode245 * (-50998291));
        long jDecode246 = (((decode24(bArr, 18) << 4) & 4294967295L) - (j4 * (-50998291))) - (jDecode245 * 19280294);
        long jDecode327 = (((decode32(bArr, 21) & 4294967295L) - (jDecode244 * (-50998291))) - (j4 * 19280294)) - (jDecode245 * 127719000);
        long jDecode247 = (((((decode24(bArr, 25) << 4) & 4294967295L) - (j3 * (-50998291))) - (jDecode244 * 19280294)) - (j4 * 127719000)) - (jDecode245 * (-6428113));
        long j6 = (((jDecode323 - (j3 * 19280294)) - (jDecode244 * 127719000)) - (j4 * (-6428113))) - (jDecode245 * 5343);
        long j7 = (jDecode324 & M28L) + (jDecode243 >> 28);
        long j8 = jDecode247 - (j7 * 5343);
        long j9 = (jDecode243 & M28L) + (jDecode325 >> 28);
        long jDecode328 = (decode32(bArr, 7) & 4294967295L) - (j9 * (-50998291));
        long jDecode248 = (((decode24(bArr, 11) << 4) & 4294967295L) - (j7 * (-50998291))) - (j9 * 19280294);
        long j10 = (jDecode326 - (j7 * 19280294)) - (j9 * 127719000);
        long j11 = (jDecode246 - (j7 * 127719000)) - (j9 * (-6428113));
        long j12 = (jDecode327 - (j7 * (-6428113))) - (j9 * 5343);
        long j13 = (jDecode325 & M28L) + (j5 >> 28);
        long j14 = j5 & M28L;
        long jDecode249 = ((decode24(bArr, 4) << 4) & 4294967295L) - (j13 * (-50998291));
        long j15 = jDecode328 - (j13 * 19280294);
        long j16 = jDecode248 - (j13 * 127719000);
        ...
        long j23 = j22 >>> 27;
        long j24 = j21 + j23;
        long jDecode329 = (decode32(bArr, 0) & 4294967295L) - (j24 * (-50998291));
        long j25 = j15 - (j24 * 127719000);
        long j26 = j16 - (j24 * (-6428113));
        long j27 = j17 - (j24 * 5343);
        long j28 = (jDecode249 - (j24 * 19280294)) + (jDecode329 >> 28);
        long j29 = jDecode329 & M28L;
        long j30 = j25 + (j28 >> 28);
        long j31 = j28 & M28L;
        long j32 = j26 + (j30 >> 28);
        long j33 = j30 & M28L;
        ...
        encode56(j53 | (j55 << 28), bArr2, 7);
        encode56(j57 | (j59 << 28), bArr2, 14);
        encode56(j61 | (j63 << 28), bArr2, 21);
        encode32((int) j62, bArr2, 28);
        return bArr2;
    }
