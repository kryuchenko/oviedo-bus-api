...
public class AESEngine implements BlockCipher {
    ...
    private void encryptBlock(int[][] iArr) {
        ...
        byte[] bArr2 = this.s;
        int i11 = (i10 ^ ((bArr2[(iShift11 >> 16) & 255] & 255) << 16)) ^ (bArr2[(i9 >> 24) & 255] << Ascii.CAN);
        int[] iArr5 = iArr[i6 + 1];
        this.C0 = i11 ^ iArr5[0];
        this.C1 = ((((bArr2[iShift10 & 255] & 255) ^ ((bArr[(iShift11 >> 8) & 255] & 255) << 8)) ^ ((bArr[(i9 >> 16) & 255] & 255) << 16)) ^ (bArr2[(iShift9 >> 24) & 255] << Ascii.CAN)) ^ iArr5[1];
        this.C2 = ((((bArr2[iShift11 & 255] & 255) ^ ((bArr[(i9 >> 8) & 255] & 255) << 8)) ^ ((bArr[(iShift9 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift10 >> 24) & 255] << Ascii.CAN)) ^ iArr5[2];
        this.C3 = ((((bArr2[i9 & 255] & 255) ^ ((bArr2[(iShift9 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(iShift10 >> 16) & 255] & 255) << 16)) ^ (bArr[(iShift11 >> 24) & 255] << Ascii.CAN)) ^ iArr5[3];
    }
