...
public class LayerParser {
    ...
    public static Layer parse(LottieComposition lottieComposition) {
        ...
        return new Layer(Collections.EMPTY_LIST, lottieComposition, "__container", -1L, Layer.LayerType.PRE_COMP, -1L, null, Collections.EMPTY_LIST, new AnimatableTransform(), 0, 0, 0, 0.0f, 0.0f, bounds.width(), bounds.height(), null, null, Collections.EMPTY_LIST, Layer.MatteType.NONE, null, false);
    }
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        jsonReader.endObject();
        float f2 = fNextDouble / fNextDouble2;
        float endFrame = fNextDouble4 / fNextDouble2;
        ...
        arrayList2.add(new Keyframe(lottieComposition, f, f, null, endFrame, Float.valueOf(Float.MAX_VALUE)));
        if (strNextString.endsWith(".ai") || "ai".equals(strNextString2)) {
            lottieComposition.addWarning("Convert your Illustrator layers to shape layers.");
        }
        return new Layer(arrayList, lottieComposition, strNextString, jNextInt, layerType, jNextInt2, strNextString3, arrayList3, animatableTransform, iNextInt2, iNextInt, color, fNextDouble2, fNextDouble3, iNextInt3, iNextInt4, documentData, animatableTextProperties, arrayList2, matteType2, animatableFloatValue, zNextBoolean);
    }
}
