...
public class PathKeyframeAnimation extends KeyframeAnimation<PointF> {
    ...
    public PointF getValue(Keyframe<PointF> keyframe, float f) {
        ...
        if (this.valueCallback != null) {
            f2 = f;
            PointF pointF = (PointF) this.valueCallback.getValueInternal(pathKeyframe.startFrame, pathKeyframe.endFrame.floatValue(), pathKeyframe.startValue, pathKeyframe.endValue, getLinearCurrentKeyframeProgress(), f2, getProgress());
            if (pointF != null) {
                return pointF;
            }
        } else {
