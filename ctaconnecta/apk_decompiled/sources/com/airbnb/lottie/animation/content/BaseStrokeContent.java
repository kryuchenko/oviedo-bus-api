                ...
                if (f2 >= f + length2 || f >= f2) {
                    ...
                    if (f3 >= fFloatValue2 && f <= fFloatValue3) {
                        if (f3 <= fFloatValue3 && fFloatValue2 < f) {
                            ...
                            Utils.applyTrimPathIfNeeded(this.trimPathPath, fFloatValue2 < f ? 0.0f : (fFloatValue2 - f) / length2, fFloatValue3 <= f3 ? (fFloatValue3 - f) / length2 : 1.0f, 0.0f);
                            canvas.drawPath(this.trimPathPath, this.paint);
                        }
                    }
                } else {
                    Utils.applyTrimPathIfNeeded(this.trimPathPath, fFloatValue2 > length ? (fFloatValue2 - length) / length2 : 0.0f, Math.min(f2 / length2, 1.0f), 0.0f);
                    canvas.drawPath(this.trimPathPath, this.paint);
                }
            }
            f += length2;
