        ...
        while (i < this.mask.getMasks().size()) {
            ...
            if (i2 == 1) {
                ...
                if (i == 0) {
                    ...
                    canvas2.drawRect(this.rect, paint);
                }
                if (mask.isInverted()) {
                    applyInvertedSubtractMask(canvas2, matrix2, mask, baseKeyframeAnimation, baseKeyframeAnimation2);
                } else {
                    applySubtractMask(canvas2, matrix2, mask, baseKeyframeAnimation, baseKeyframeAnimation2);
                }
            } else if (i2 == 2) {
                canvas2 = canvas;
                matrix2 = matrix;
                if (mask.isInverted()) {
                    applyInvertedIntersectMask(canvas2, matrix2, mask, baseKeyframeAnimation, baseKeyframeAnimation2);
                } else {
                    applyIntersectMask(canvas2, matrix2, mask, baseKeyframeAnimation, baseKeyframeAnimation2);
                }
            } else if (i2 != 3) {
                canvas2 = canvas;
                matrix2 = matrix;
                ...
                canvas2 = canvas;
                matrix2 = matrix;
                applyInvertedAddMask(canvas2, matrix2, mask, baseKeyframeAnimation, baseKeyframeAnimation2);
            } else {
                canvas2 = canvas;
                matrix2 = matrix;
                applyAddMask(canvas2, matrix2, mask, baseKeyframeAnimation, baseKeyframeAnimation2);
            }
            i++;
            canvas = canvas2;
            matrix = matrix2;
