...
public final class ActivateAutoRechargeActivity_MembersInjector implements MembersInjector<ActivateAutoRechargeActivity> {
    private final Provider<PreferencesHelper> preferencesProvider;
    private final Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider;
    private final Provider<ViewModelProvider.Factory> viewModelFactoryProvider;
    private final Provider<ViewModelProvider.Factory> viewModelFactoryProvider2;

    public ActivateAutoRechargeActivity_MembersInjector(Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider, Provider<PreferencesHelper> preferencesProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider2) {
    ...
    public static MembersInjector<ActivateAutoRechargeActivity> create(Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider, Provider<PreferencesHelper> preferencesProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider2) {
        return new ActivateAutoRechargeActivity_MembersInjector(supportFragmentInjectorProvider, viewModelFactoryProvider, preferencesProvider, viewModelFactoryProvider2);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(ActivateAutoRechargeActivity instance) {
    ...
    public static void injectViewModelFactory(ActivateAutoRechargeActivity instance, ViewModelProvider.Factory viewModelFactory) {
