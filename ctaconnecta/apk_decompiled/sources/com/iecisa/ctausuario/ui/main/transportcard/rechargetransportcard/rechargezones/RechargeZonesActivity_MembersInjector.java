...
public final class RechargeZonesActivity_MembersInjector implements MembersInjector<RechargeZonesActivity> {
    ...
    public static MembersInjector<RechargeZonesActivity> create(Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider, Provider<PreferencesHelper> preferencesProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider2, Provider<PreferencesHelper> preferencesProvider2) {
        return new RechargeZonesActivity_MembersInjector(supportFragmentInjectorProvider, viewModelFactoryProvider, preferencesProvider, viewModelFactoryProvider2, preferencesProvider2);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(RechargeZonesActivity instance) {
    ...
    public static void injectViewModelFactory(RechargeZonesActivity instance, ViewModelProvider.Factory viewModelFactory) {
        instance.viewModelFactory = viewModelFactory;
    }

    public static void injectPreferences(RechargeZonesActivity instance, PreferencesHelper preferences) {
