...
public final class LargeFamilyDiscountActivity_MembersInjector implements MembersInjector<LargeFamilyDiscountActivity> {
    private final Provider<PreferencesHelper> preferencesProvider;
    private final Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider;
    private final Provider<ViewModelProvider.Factory> viewModelFactoryProvider;
    private final Provider<ViewModelProvider.Factory> viewModelFactoryProvider2;

    public LargeFamilyDiscountActivity_MembersInjector(Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider, Provider<PreferencesHelper> preferencesProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider2) {
    ...
    public static MembersInjector<LargeFamilyDiscountActivity> create(Provider<DispatchingAndroidInjector<Fragment>> supportFragmentInjectorProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider, Provider<PreferencesHelper> preferencesProvider, Provider<ViewModelProvider.Factory> viewModelFactoryProvider2) {
        return new LargeFamilyDiscountActivity_MembersInjector(supportFragmentInjectorProvider, viewModelFactoryProvider, preferencesProvider, viewModelFactoryProvider2);
    }

    @Override // dagger.MembersInjector
    public void injectMembers(LargeFamilyDiscountActivity instance) {
    ...
    public static void injectViewModelFactory(LargeFamilyDiscountActivity instance, ViewModelProvider.Factory viewModelFactory) {
