...
public final class Handshake {
    ...
    public static Handshake get(SSLSession sSLSession) throws SSLPeerUnverifiedException {
        ...
        if (peerCertificates != null) {
            listImmutableList = Util.immutableList(peerCertificates);
        } else {
            listImmutableList = Collections.EMPTY_LIST;
        }
        Certificate[] localCertificates = sSLSession.getLocalCertificates();
        if (localCertificates != null) {
            listImmutableList2 = Util.immutableList(localCertificates);
        } else {
            listImmutableList2 = Collections.EMPTY_LIST;
        }
        return new Handshake(cipherSuite, listImmutableList, listImmutableList2);
    }
