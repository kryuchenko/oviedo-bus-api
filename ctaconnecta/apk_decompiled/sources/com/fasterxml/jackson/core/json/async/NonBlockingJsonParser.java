...
public class NonBlockingJsonParser extends NonBlockingJsonParserBase implements ByteArrayFeeder {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    ...
                    case 16:
                        return _finishKeywordToken(BuildConfig.TRAVIS, this._pending32, JsonToken.VALUE_NULL);
                    case 17:
    ...
    protected final JsonToken _finishTokenWithEOF() throws IOException {
        ...
        if (i != 50) {
            switch (i) {
                case 16:
                    return _finishKeywordTokenWithEOF(BuildConfig.TRAVIS, this._pending32, JsonToken.VALUE_NULL);
                case 17:
                ...
                default:
                    switch (i) {
                        case 24:
                        case 25:
                            return _valueCompleteInt(0, StdEntropyCoder.DEF_THREADS_NUM);
                        case 26:
    ...
    private final JsonToken _startFieldNameAfterComma(int i) throws IOException {
        ...
        _updateTokenLocation();
        if (i_skipWS != 34) {
            if (i_skipWS == 125 && JsonParser.Feature.ALLOW_TRAILING_COMMA.enabledIn(this._features)) {
                return _closeObjectScope();
            }
    ...
    */
    ...
    protected JsonToken _startNullToken() throws IOException {
        ...
        this._minorState = 16;
        return _finishKeywordToken(BuildConfig.TRAVIS, 1, JsonToken.VALUE_NULL);
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x007a, code lost:
        ...
        if (r6._inputPtr < r6._inputEnd) goto L28;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x0097, code lost:
        ...
        return _finishFloatExponent(true, r0[r1] & 255);
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
            ...
            if (iArr[i_decodeCharEscape] == 0) {
                ...
                if (i_decodeCharEscape > 127) {
                    ...
                    if (i_decodeCharEscape < 2048) {
                        ...
                        int i7 = (i2 << 8) | (i_decodeCharEscape >> 12) | PassportService.DEFAULT_MAX_BLOCKSIZE;
                        int i8 = i3 + 1;
                        if (i8 >= 4) {
                ...
                if (i_decodeCharEscape != 34 && iArr[i_decodeCharEscape] != 0) {
                    ...
                    if (i_decodeCharEscape > 127) {
                        ...
                        if (i_decodeCharEscape < 2048) {
                            ...
                            int i6 = (i2 << 8) | (i_decodeCharEscape >> 12) | PassportService.DEFAULT_MAX_BLOCKSIZE;
                            int i7 = i3 + 1;
                            if (i7 >= 4) {
                                if (i >= iArrGrowArrayBy.length) {
                                    int[] iArrGrowArrayBy2 = growArrayBy(iArrGrowArrayBy, iArrGrowArrayBy.length);
    ...
    protected final JsonToken _finishFieldWithEscape() throws IOException {
        ...
        if (i_decodeSplitEscaped > 127) {
            ...
            if (i_decodeSplitEscaped < 2048) {
                ...
                int i8 = (i3 << 8) | (i_decodeSplitEscaped >> 12) | PassportService.DEFAULT_MAX_BLOCKSIZE;
                i4++;
                if (i4 >= 4) {
