...
public class UTF8StreamJsonParser extends ParserBase {
    ...
    */
    ...
    protected final String parseLongName(int i, int i2, int i3) throws IOException {
        ...
        while (this._inputPtr + 4 <= this._inputEnd) {
            ...
            if (iArr3[i13] != 0) {
                if (i13 == 34) {
                    return findName(this._quadBuffer, i10, i11, 2);
                }
                return parseEscapedName(this._quadBuffer, i10, i11, i13, 2);
            }
            int i14 = (i11 << 8) | i13;
            ...
            if (iArr3[i16] != 0) {
                if (i16 == 34) {
                    return findName(this._quadBuffer, i10, i14, 3);
                }
                return parseEscapedName(this._quadBuffer, i10, i14, i16, 3);
            }
            int i17 = (i14 << 8) | i16;
            ...
            if (iArr3[i19] != 0) {
                if (i19 == 34) {
                    return findName(this._quadBuffer, i10, i17, 4);
                }
                return parseEscapedName(this._quadBuffer, i10, i17, i19, 4);
            }
            int[] iArr4 = this._quadBuffer;
            if (i10 >= iArr4.length) {
                this._quadBuffer = growArrayBy(iArr4, i10);
            }
            this._quadBuffer[i10] = i17;
            i5 = i19;
            iArr2 = iArr3;
            i6 = i10 + 1;
            i4 = 1;
        ...
        int i20 = i6;
        return parseEscapedName(this._quadBuffer, i20, 0, i5, 0);
    }
            ...
            if (iArr[i_decodeEscaped] != 0 && i_decodeEscaped != 34) {
                ...
                if (i_decodeEscaped > 127) {
                    ...
                    if (i_decodeEscaped < 2048) {
                        ...
                        int i5 = (i4 << 8) | (i_decodeEscaped >> 12) | PassportService.DEFAULT_MAX_BLOCKSIZE;
                        int i6 = i2 + 1;
                        if (i6 >= 4) {
                            if (i3 >= iArrGrowArrayBy.length) {
                                iArrGrowArrayBy = growArrayBy(iArrGrowArrayBy, iArrGrowArrayBy.length);
    ...
    */
    ...
    protected final void _matchNull() throws IOException {
        ...
        _matchToken2(BuildConfig.TRAVIS, 1);
    }
