                ...
                while (i4 < length) {
                    ...
                    if (zIncludeField || zIncludeField2) {
                        ...
                        while (i5 < size) {
                            ...
                            int i7 = length;
                            BoundField boundField2 = (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory.createBoundField(gson, field2, method, str, TypeToken.get(typeResolve), z8, z3, z7));
                            if (boundField == null) {
