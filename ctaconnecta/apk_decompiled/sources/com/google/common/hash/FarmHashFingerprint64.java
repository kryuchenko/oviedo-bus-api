...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            weakHashLength32WithSeeds(bArr2, i8, jArr[1] * j5, j6 + jArr2[0], jArr);
            int i9 = i8;
            long[] jArr3 = jArr;
            weakHashLength32WithSeeds(bArr2, i9 + 32, jArr2[1] + jRotateRight3, jLoad642 + LittleEndianByteArray.load64(bArr2, i9 + 16), jArr2);
            i8 = i9 + 64;
            if (i8 == i4) {
                long j7 = ((j6 & 255) << 1) + j5;
                long j8 = jArr2[0] + i5;
                ...
                long jRotateRight5 = Long.rotateRight(jLoad642 + jArr3[1] + LittleEndianByteArray.load64(bArr2, i6 - 15), 42) * j7;
                ...
                weakHashLength32WithSeeds(bArr2, i7, jArr3[1] * j7, jArr2[0] + j10, jArr3);
                weakHashLength32WithSeeds(bArr2, i6 - 31, jArr2[1] + jRotateRight6, LittleEndianByteArray.load64(bArr2, i6 - 47) + jLoad643, jArr2);
                return hashLength16(hashLength16(jArr3[0], jArr2[0], j7) + (shiftMix(jLoad643) * K0) + j10, hashLength16(jArr3[1], jArr2[1], j7) + jRotateRight6, j7);
            }
            bArr2 = bArr;
