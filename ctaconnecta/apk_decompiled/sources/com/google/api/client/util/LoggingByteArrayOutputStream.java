...
public class LoggingByteArrayOutputStream extends ByteArrayOutputStream implements AutoCloseable {
    ...
    public synchronized void close() throws IOException {
        if (!this.closed) {
            if (this.bytesWritten != 0) {
                ...
                if (this.count != 0) {
                    this.logger.log(this.loggingLevel, toString(com.bumptech.glide.load.Key.STRING_CHARSET_NAME).replaceAll("[\\x00-\\x09\\x0B\\x0C\\x0E-\\x1F\\x7F]", " "));
                }
            }
            this.closed = true;
        }
