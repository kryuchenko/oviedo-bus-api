...
public class Credential implements HttpExecuteInterceptor, HttpRequestInitializer, HttpUnsuccessfulResponseHandler {
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0026 A[Catch: all -> 0x002e, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x002e, blocks: (B:3:0x0005, B:6:0x000f, B:12:0x0026, B:8:0x0019), top: B:17:0x0005 }] */
    ...
    public boolean handleResponse(HttpRequest httpRequest, HttpResponse httpResponse, boolean z) {
        ...
        if (authenticateAsList != null) {
            for (String str : authenticateAsList) {
                if (str.startsWith(Constants.Api.BEARER)) {
