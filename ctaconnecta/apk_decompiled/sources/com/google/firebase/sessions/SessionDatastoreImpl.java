...
public final class SessionDatastoreImpl implements SessionDatastore {
    ...
    public SessionDatastoreImpl(Context context, CoroutineContext backgroundDispatcher) {
        ...
        final Flow flowM2513catch = FlowKt.m2513catch(Companion.getDataStore(context).getData(), new SessionDatastoreImpl$firebaseSessionDataFlow$1(null));
        this.firebaseSessionDataFlow = new Flow<FirebaseSessionsData>() { // from class: com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1
            ...
            public Object collect(FlowCollector<? super FirebaseSessionsData> flowCollector, Continuation continuation) {
                Object objCollect = flowM2513catch.collect(new AnonymousClass2(flowCollector, this), continuation);
    ...
    static final class C01661 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C01661(String str, Continuation<? super C01661> continuation) {
            super(2, continuation);
            this.$sessionId = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionDatastoreImpl.this.new C01661(this.$sessionId, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (PreferencesKt.edit(SessionDatastoreImpl.Companion.getDataStore(SessionDatastoreImpl.this.context), new C01081(this.$sessionId, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        static final class C01081 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
            final /* synthetic */ String $sessionId;
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01081 c01081 = new C01081(this.$sessionId, continuation);
                c01081.L$0 = obj;
                return c01081;
            }
            ...
            public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
                return ((C01081) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
            }
    ...
    public void updateSessionId(String sessionId) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C01661(sessionId, null), 3, null);
    }
