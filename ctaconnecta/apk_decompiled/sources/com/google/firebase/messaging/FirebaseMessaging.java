...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda3
                ...
                public final void onNewToken(String str) {
                    this.f$0.m637lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m638lambda$new$2$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        taskCreateInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            ...
            public final void onSuccess(Object obj) {
                this.f$0.m639lambda$new$3$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m640lambda$new$4$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }

    /* renamed from: lambda$new$2$com-google-firebase-messaging-FirebaseMessaging, reason: not valid java name */
    /* synthetic */ void m638lambda$new$2$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    /* synthetic */ void m639lambda$new$3$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public void m640lambda$new$4$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda12
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                this.f$0.m636x8ede5a30((CloudMessage) obj);
            }
        });
    }
    ...
    /* synthetic */ void m636x8ede5a30(CloudMessage cloudMessage) {
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z).addOnSuccessListener(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6(), new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda10
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                this.f$0.m641x6495830d((Void) obj);
            }
        });
    }
    ...
    /* synthetic */ void m641x6495830d(Void r3) {
        ProxyNotificationPreferences.setProxyRetention(this.context, this.gmsRpc, shouldRetainProxyNotifications());
    }
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m635x6a533e85(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m635x6a533e85(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m633xd5738b77(taskCompletionSource);
                }
            });
            return taskCompletionSource.getTask();
        }
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m634xd4fd2578(taskCompletionSource2);
            }
        });
    ...
    /* synthetic */ void m633xd5738b77(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    /* synthetic */ void m634xd4fd2578(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public void send(RemoteMessage remoteMessage) {
        ...
        intent.putExtra(EXTRA_DUMMY_P_INTENT, PendingIntent.getBroadcast(this.context, 0, intent2, Build.VERSION.SDK_INT >= 23 ? AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL : 0));
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda14
                ...
                public final Task start() {
                    return this.f$0.m632xb7d2b1c4(defaultSenderId, tokenWithoutTriggeringSync);
                }
            }));
    ...
    /* synthetic */ Task m632xb7d2b1c4(final String str, final Store.Token token) {
    ...
    public void m637lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    class AutoInit {
        ...
        /* synthetic */ void m642x1061f0b8(Event event) {
            if (isEnabled()) {
