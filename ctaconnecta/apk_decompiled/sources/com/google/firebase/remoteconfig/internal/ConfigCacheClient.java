...
public class ConfigCacheClient {
    ...
    private static final Executor DIRECT_EXECUTOR = new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda6();
    ...
    /* synthetic */ Void m671xddaae01c(ConfigContainer configContainer) throws Exception {
    ...
    public Task<ConfigContainer> put(final ConfigContainer configContainer, final boolean z) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.internal.ConfigCacheClient$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return this.f$0.m671xddaae01c(configContainer);
            }
            ...
            public final Task then(Object obj) {
                return this.f$0.m672x9820809d(z, configContainer, (Void) obj);
            }
        });
    }

    /* renamed from: lambda$put$1$com-google-firebase-remoteconfig-internal-ConfigCacheClient, reason: not valid java name */
    /* synthetic */ Task m672x9820809d(boolean z, ConfigContainer configContainer, Void r3) throws Exception {
        if (z) {
