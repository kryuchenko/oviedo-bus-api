...
public final class zzd {
    ...
    public static AnalyticsConnector.ConditionalUserProperty zza(Bundle bundle) {
        ...
        conditionalUserProperty.name = (String) Preconditions.checkNotNull((String) zzik.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.NAME, String.class, null));
