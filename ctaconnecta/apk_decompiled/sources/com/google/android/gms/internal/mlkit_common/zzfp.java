...
public final class zzfp extends zzdu<String> implements zzfs, RandomAccess {
    ...
    public final boolean addAll(int i, Collection<? extends String> collection) {
        ...
        if (collection instanceof zzfs) {
            collection = ((zzfs) collection).zzd();
        }
    ...
    @Override // com.google.android.gms.internal.mlkit_common.zzdu, com.google.android.gms.internal.mlkit_common.zzfi
