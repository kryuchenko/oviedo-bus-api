...
interface zzjj {
    ...
    void zza(int i, zzeu zzeuVar) throws IOException;

    <K, V> void zza(int i, zzhb<K, V> zzhbVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhx zzhxVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhx zzhxVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhx zzhxVar) throws IOException;

    void zzb(int i, List<zzeu> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhx zzhxVar) throws IOException;
