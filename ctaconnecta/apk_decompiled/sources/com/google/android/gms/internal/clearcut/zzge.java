...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C0017zza> implements zzdq {
        ...
        public static final class C0017zza extends zzcg.zza<zza, C0017zza> implements zzdq {
            ...
            /* synthetic */ C0017zza(zzgf zzgfVar) {
                this();
            }
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            GEARHEAD_ANDROID_PRIMES(HttpStatusCodes.STATUS_CODE_CREATED),
            INSTORE_CONSUMER_PRIMES(207),
            SAMPLE_IOS_PRIMES(HttpStatusCodes.STATUS_CODE_ACCEPTED),
            ...
            GBOARD(199),
            CRONET_GMM(203),
            TRUSTED_FACE(HttpStatusCodes.STATUS_CODE_NO_CONTENT),
            MATCHSTICK(205),
            ...
            EARTH(334),
            EARTH_COUNTERS(HttpStatusCodes.STATUS_CODE_METHOD_NOT_ALLOWED),
            CALENDAR_CLIENT(335),
            ...
            VR_SDK_ANDROID_PRIMES(HttpStatusCodes.STATUS_CODE_NOT_FOUND),
            PHOTOS_SCANNER(406),
            BG_IN_OGB(407),
            BLOGGER(408),
            CORP_IOS_FOOD(HttpStatusCodes.STATUS_CODE_CONFLICT),
            BEACON_GCORE_TEST(410),
            LINKS_IOS_PRIMES(411),
            CHAUFFEUR(HttpStatusCodes.STATUS_CODE_PRECONDITION_FAILED),
            SNAPSEED(413),
