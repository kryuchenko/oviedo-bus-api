...
final class zzic extends zzhx {
    ...
    */
            ...
            if (bZza >= -32) {
                if (bZza >= -16) {
                    ...
                    if (i9 >= i6) {
                        i8 -= 4;
                        long j8 = j6 + j;
                        byte bZza2 = zzhw.zza(bArr, j6);
                        if (bZza2 <= -65 && (((bZza << 28) + (bZza2 + ISO7816.INS_MANAGE_CHANNEL)) >> 30) == 0) {
                            long j9 = j6 + 2;
                            if (zzhw.zza(bArr, j8) > -65) {
                                break;
                            }
                            j6 += 3;
                            if (zzhw.zza(bArr, j9) > -65) {
                                break;
                            }
                        } else {
                            break;
                    ...
                    long j10 = j3;
                    long j11 = j6 + j10;
                    byte bZza3 = zzhw.zza(bArr, j6);
                    if (bZza3 > -65 || ((bZza == -32 && bZza3 < -96) || (bZza == -19 && bZza3 >= -96))) {
                        break;
                    }
                    j6 += 2;
                    if (zzhw.zza(bArr, j11) > -65) {
                        break;
                    }
                    j3 = j10;
                }
    ...
    final int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i4 < length) {
            ...
            if (cCharAt3 < 128 && j4 < j5) {
                    ...
                    if (j4 <= j3 - 4) {
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt3, cCharAt4)) {
                                ...
                                zzhw.zza(bArr, j4 + j2, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j6 = j4 + 3;
                                zzhw.zza(bArr, j4 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                j4 += 4;
                                zzhw.zza(bArr, j6, (byte) ((codePoint & 63) | 128));
                                i4 = i5;
                            } else {
                                i4 = i5;
                            }
                ...
                zzhw.zza(bArr, j4, (byte) ((cCharAt3 >>> '\f') | 480));
                j3 = j5;
                long j7 = j4 + 2;
                zzhw.zza(bArr, j4 + j2, (byte) (((cCharAt3 >>> 6) & 63) | 128));
                j4 += 3;
                zzhw.zza(bArr, j7, (byte) ((cCharAt3 & '?') | 128));
            } else {
                j2 = j;
                long j8 = j4 + j2;
                zzhw.zza(bArr, j4, (byte) ((cCharAt3 >>> 6) | 960));
                j4 += 2;
                zzhw.zza(bArr, j8, (byte) ((cCharAt3 & '?') | 128));
                j3 = j5;
            }
            i4++;
            j = j2;
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return zzhy.zzb(i, zzhw.zza(bArr, j));
        }
        if (i2 == 2) {
            return zzhy.zzb(i, zzhw.zza(bArr, j), zzhw.zza(bArr, j + 1));
        }
