...
public enum zzac implements zzep {
    NO_ERROR(0),
    ...
    private static final zzeo<zzac> zzac = new zzeo<zzac>() { // from class: com.google.android.gms.internal.mlkit_vision_common.zzae
    };
    ...
    public final String toString() {
        return "<" + getClass().getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzad + " name=" + name() + Typography.greater;
    }
