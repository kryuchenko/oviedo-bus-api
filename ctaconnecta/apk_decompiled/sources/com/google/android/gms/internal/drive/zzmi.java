...
class zzmi<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private zzmi(int i) {
        ...
        this.zzvf = Collections.EMPTY_MAP;
        this.zzvh = Collections.EMPTY_MAP;
    }
    ...
    */
    private final int zza(K k) {
        ...
        if (i3 < 0) {
            ...
            while (i <= i3) {
                int i4 = (i + i3) / 2;
                int iCompareTo = k.compareTo((Comparable) this.zzve.get(i4).getKey());
                if (iCompareTo < 0) {
                    i3 = i4 - 1;
                } else {
                    if (iCompareTo <= 0) {
            ...
            int iCompareTo2 = k.compareTo((Comparable) this.zzve.get(i3).getKey());
            if (iCompareTo2 > 0) {
                i2 = size + 1;
            } else {
                if (iCompareTo2 == 0) {
