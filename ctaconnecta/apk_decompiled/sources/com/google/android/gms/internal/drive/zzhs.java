...
public final class zzhs {
    ...
    public static final MetadataField<Boolean> zzjy = new zzht("isExplicitlyTrashed", Collections.singleton("trashed"), Collections.EMPTY_SET, GmsVersion.VERSION_ORLA);
    ...
    public static final MetadataField<BitmapTeleporter> zzkq = new zzhu("thumbnail", Collections.EMPTY_SET, Collections.EMPTY_SET, GmsVersion.VERSION_KENAFA);
