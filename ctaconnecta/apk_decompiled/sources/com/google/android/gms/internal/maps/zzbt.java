...
final class zzbt extends zzbl {
    ...
    */
    static zzbt zzg(int i, Object[] objArr, zzbk zzbkVar) {
        ...
        if (i2 == 1) {
            ...
            if (iZzf <= 128) {
                    ...
                    while (true) {
                        ...
                        if (i10 == 255) {
                            ...
                            if (objRequireNonNull.equals(objArrCopyOf[i10])) {
                                int i11 = i10 ^ 1;
                                zzbj zzbjVar = new zzbj(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArrCopyOf[i11]));
                ...
                if (iZzf > 32768) {
                        ...
                        while (true) {
                            ...
                            if (i17 == -1) {
                                ...
                                if (objRequireNonNull3.equals(objArrCopyOf[i17])) {
                                    int i18 = i17 ^ 1;
                                    zzbj zzbjVar2 = new zzbj(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArrCopyOf[i18]));
                    ...
                    return new zzbt(obj2, objArrCopyOf, i2);
                }
                sArr = new short[iZzf];
                    ...
                    while (true) {
                        ...
                        if (c3 == 65535) {
                            ...
                            if (objRequireNonNull5.equals(objArrCopyOf[c3])) {
                                int i24 = c3 ^ 1;
                                zzbj zzbjVar3 = new zzbj(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArrCopyOf[i24]));
        ...
        return new zzbt(obj22, objArrCopyOf, i2);
    }
