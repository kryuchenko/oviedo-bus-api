        ...
        while (i < i3) {
            ...
            if (zzjz.zzd(b2)) {
                ...
                if (i6 < i3 - 1) {
                    int i8 = i + 2;
                    i += 3;
                    zzjz.zza(b2, bArr[i6], bArr[i8], cArr, i5);
                    i5++;
                } else {
                    throw zzhh.zzgu();
                }
                ...
                byte b5 = bArr[i + 2];
                i += 4;
                zzjz.zza(b2, b4, b5, bArr[i9], cArr, i5);
                i5 += 2;
            }
        }
