...
final class zzfw {
    static String zza(zzfv zzfvVar, String str) throws SecurityException {
    ...
    */
    private static void zza(zzfv zzfvVar, StringBuilder sb, int i) throws SecurityException {
        boolean zEquals;
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : zzfvVar.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (strSubstring.endsWith("List") && !strSubstring.endsWith("OrBuilderList") && !strSubstring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zza(strConcat), zzek.zza(method2, zzfvVar, new Object[0]));
                }
            }
            if (strSubstring.endsWith("Map") && !strSubstring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zza(strConcat2), zzek.zza(method3, zzfvVar, new Object[0]));
                }
            }
            ...
            if (((Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object objZza = zzek.zza(method4, zzfvVar, new Object[0]);
                    if (method5 == null) {
                        ...
                        } else if (objZza instanceof zzdj) {
                            zEquals = objZza.equals(zzdj.zza);
                        } else if (!(objZza instanceof zzfv) ? !(objZza instanceof Enum) || ((Enum) objZza).ordinal() != 0 : objZza != ((zzfv) objZza).zzn()) {
                        }
                        if (zEquals) {
                            zBooleanValue = false;
                        }
                    } else {
                        zBooleanValue = ((Boolean) zzek.zza(method5, zzfvVar, new Object[0])).booleanValue();
                    }
                    if (zBooleanValue) {
        ...
        if (zzfvVar instanceof zzek.zzc) {
            Iterator<Map.Entry<T, Object>> itZzd = ((zzek.zzc) zzfvVar).zzc.zzd();
            if (itZzd.hasNext()) {
                throw new NoSuchMethodError();
            }
        }
        zzek zzekVar = (zzek) zzfvVar;
        if (zzekVar.zzb != null) {
            zzekVar.zzb.zza(sb, i);
        }
    }
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(zzgw.zza(zzdj.zza((String) obj)));
            sb.append(Typography.quote);
            return;
        }
        if (obj instanceof zzdj) {
            sb.append(": \"");
            sb.append(zzgw.zza((zzdj) obj));
            sb.append(Typography.quote);
            return;
        }
