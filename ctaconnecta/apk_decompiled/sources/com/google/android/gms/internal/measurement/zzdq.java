...
public class zzdq {
    ...
    public final int zza(String str) {
        ...
        Integer num = (Integer) zzdc.zza(zzdcVar.zza(DeviceOrientationRequest.OUTPUT_PERIOD_MEDIUM), Integer.class);
        if (num == null) {
            return 25;
        }
        return num.intValue();
    ...
    public final Bundle zza(Bundle bundle, boolean z) {
        ...
        if (z) {
            return zzdcVar.zza(DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
        }
        return null;
    }
    ...
    public final List<Bundle> zza(String str, String str2) {
        ...
        List<Bundle> list = (List) zzdc.zza(zzdcVar.zza(DeviceOrientationRequest.OUTPUT_PERIOD_FAST), List.class);
    ...
    public final Map<String, Object> zza(String str, String str2, boolean z) {
        ...
        Bundle bundleZza = zzdcVar.zza(DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    ...
    public final void zza(Exception exc, boolean z, boolean z2) {
        ...
        if (z2) {
            zzdqVar = this;
            exc2 = exc;
            zzdqVar.zza(5, "Error with data collection. Data lost.", exc2, (Object) null, (Object) null);
        } else {
            zzdqVar = this;
            exc2 = exc;
        }
        Log.w(zzdqVar.zzc, "Error with data collection. Data lost.", exc2);
    }
