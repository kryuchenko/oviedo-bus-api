...
interface zzkl {
    ...
    void zza(int i, zzfm zzfmVar) throws IOException;

    <K, V> void zza(int i, zzhy<K, V> zzhyVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zziw zziwVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zziw zziwVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zziw zziwVar) throws IOException;

    void zzb(int i, List<zzfm> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zziw zziwVar) throws IOException;
