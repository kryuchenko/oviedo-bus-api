...
public final class zzfp<K, V> extends LinkedHashMap<K, V> {
    ...
    private zzfp(Map<K, V> map) {
        super(map);
        this.zza = true;
    }

    public final void zza(zzfp<K, V> zzfpVar) {
        zzd();
        if (zzfpVar.isEmpty()) {
            return;
        }
    ...
    public final zzfp<K, V> zza() {
        return isEmpty() ? new zzfp<>() : new zzfp<>(this);
    }
