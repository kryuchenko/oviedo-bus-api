...
public final class zzai implements zzaq {
    ...
    public final String zzf() throws NumberFormatException {
        ...
        BigDecimal bigDecimal = bigDecimalValueOf.signum() == 0 ? new BigDecimal(BigInteger.ZERO, 0) : JsonNodeFactory$$ExternalSyntheticBackportWithForwarding0.m(bigDecimalValueOf);
