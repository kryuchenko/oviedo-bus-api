...
public abstract class zzh<E> extends zze<E> implements List<E>, RandomAccess {
    ...
    public static <E> zzh<E> zza(E e, E e2, E e3, E e4, E e5) {
    ...
    public int indexOf(@NullableDecl Object obj) {
        ...
        while (listIterator.hasNext()) {
            if (zza.zza(obj, listIterator.next())) {
    ...
    public int lastIndexOf(@NullableDecl Object obj) {
        ...
        if (!(this instanceof RandomAccess)) {
            ...
            while (listIterator.hasPrevious()) {
                if (zza.zza(obj, listIterator.previous())) {
    ...
    public zzh<E> subList(int i, int i2) {
        ...
        if (i3 == 0) {
            return (zzh<E>) zzi.zza;
        }
        return new zzj(this, i, i3);
    }
    ...
    @Override // com.google.android.gms.internal.mlkit_vision_common.zze, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
