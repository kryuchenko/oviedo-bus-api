...
final class zzhl {
    static String zza(zzhg zzhgVar, String str) throws SecurityException {
    ...
    */
    private static void zza(zzhg zzhgVar, StringBuilder sb, int i) throws SecurityException {
        boolean zEquals;
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : zzhgVar.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (strSubstring.endsWith("List") && !strSubstring.endsWith("OrBuilderList") && !strSubstring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zza(strConcat), zzfy.zza(method2, zzhgVar, new Object[0]));
                }
            }
            if (strSubstring.endsWith("Map") && !strSubstring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zza(strConcat2), zzfy.zza(method3, zzhgVar, new Object[0]));
                }
            }
            ...
            if (((Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object objZza = zzfy.zza(method4, zzhgVar, new Object[0]);
                    if (method5 == null) {
                        ...
                        } else if (objZza instanceof zzeu) {
                            zEquals = objZza.equals(zzeu.zza);
                        } else if (!(objZza instanceof zzhg) ? !(objZza instanceof Enum) || ((Enum) objZza).ordinal() != 0 : objZza != ((zzhg) objZza).zzi()) {
                        }
                        if (zEquals) {
                            zBooleanValue = false;
                        }
                    } else {
                        zBooleanValue = ((Boolean) zzfy.zza(method5, zzhgVar, new Object[0])).booleanValue();
                    }
                    if (zBooleanValue) {
        ...
        if (zzhgVar instanceof zzfy.zze) {
            Iterator<Map.Entry<T, Object>> itZzd = ((zzfy.zze) zzhgVar).zzc.zzd();
            if (itZzd.hasNext()) {
                throw new NoSuchMethodError();
            }
        }
        zzfy zzfyVar = (zzfy) zzhgVar;
        if (zzfyVar.zzb != null) {
            zzfyVar.zzb.zza(sb, i);
        }
    }
    ...
    static final void zza(StringBuilder sb, int i, String str, Object obj) throws SecurityException {
        ...
        if (obj instanceof String) {
            sb.append(": \"");
            sb.append(zzil.zza(zzeu.zza((String) obj)));
            sb.append(Typography.quote);
            return;
        }
        if (obj instanceof zzeu) {
            sb.append(": \"");
            sb.append(zzil.zza((zzeu) obj));
            sb.append(Typography.quote);
            return;
        }
