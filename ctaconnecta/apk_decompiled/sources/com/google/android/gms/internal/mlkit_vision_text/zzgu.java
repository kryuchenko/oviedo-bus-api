...
final class zzgu extends zzet<Long> implements zzgh<Long>, zzht, RandomAccess {
    private static final zzgu zza;
    private long[] zzb;
    private int zzc;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzguVar.zzc) {
            return false;
        }
        long[] jArr = zzguVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzgb.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        System.arraycopy(zzguVar.zzb, 0, this.zzb, this.zzc, zzguVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzgh<Long> zzb(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzgu(Arrays.copyOf(this.zzb, i), this.zzc);
    }
    ...
    static {
        zzgu zzguVar = new zzgu(new long[0], 0);
        zza = zzguVar;
        zzguVar.zzb();
    }
}
