...
class zzgn<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    static <FieldDescriptorType extends zzeh<FieldDescriptorType>> zzgn<FieldDescriptorType, Object> zza(int i) {
        return new zzgm(i);
    }
    ...
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int iZza = zza((zzgn<K, V>) comparable);
        if (iZza >= 0) {
    ...
    public final V zza(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzgs zzgsVarRemove = this.zzb.remove(i2 - 1);
            zzg().put((Comparable) zzgsVarRemove.getKey(), zzgsVarRemove.getValue());
        }
    ...
    */
    ...
    public /* synthetic */ Object put(Object obj, Object obj2) {
        return zza((zzgn<K, V>) obj, (Comparable) obj2);
    }

    /* synthetic */ zzgn(int i, zzgm zzgmVar) {
        this(i);
    }
}
