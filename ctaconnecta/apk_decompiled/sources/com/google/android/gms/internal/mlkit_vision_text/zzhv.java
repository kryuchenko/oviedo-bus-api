...
final class zzhv<E> extends zzet<E> implements RandomAccess {
    private static final zzhv<Object> zza;
    private E[] zzb;
    private int zzc;

    public static <E> zzhv<E> zzd() {
        return (zzhv<E>) zza;
    }
    ...
    public final /* synthetic */ zzgh zzb(int i) {
        ...
        return new zzhv(Arrays.copyOf(this.zzb, i), this.zzc);
    }

    static {
        zzhv<Object> zzhvVar = new zzhv<>(new Object[0], 0);
        zza = zzhvVar;
        zzhvVar.zzb();
    }
}
