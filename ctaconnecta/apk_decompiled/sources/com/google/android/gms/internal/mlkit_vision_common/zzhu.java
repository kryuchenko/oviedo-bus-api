...
interface zzhu {
    ...
    void zza(int i, zzdj zzdjVar) throws IOException;

    <K, V> void zza(int i, zzfm<K, V> zzfmVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzgi zzgiVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzgi zzgiVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzgi zzgiVar) throws IOException;

    void zzb(int i, List<zzdj> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzgi zzgiVar) throws IOException;
