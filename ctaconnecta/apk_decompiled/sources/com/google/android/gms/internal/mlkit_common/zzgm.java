...
final class zzgm {
    ...
    */
    private static void zza(zzgh zzghVar, StringBuilder sb, int i) throws SecurityException {
        boolean zEquals;
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : zzghVar.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (strSubstring.endsWith("List") && !strSubstring.endsWith("OrBuilderList") && !strSubstring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zza(sb, i, zza(strConcat), zzez.zza(method2, zzghVar, new Object[0]));
                }
            }
            if (strSubstring.endsWith("Map") && !strSubstring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zza(sb, i, zza(strConcat2), zzez.zza(method3, zzghVar, new Object[0]));
                }
            }
            ...
            if (((Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object objZza = zzez.zza(method4, zzghVar, new Object[0]);
                    if (method5 == null) {
                        ...
                        } else if (objZza instanceof zzdv) {
                            zEquals = objZza.equals(zzdv.zza);
                        } else if (!(objZza instanceof zzgh) ? !(objZza instanceof Enum) || ((Enum) objZza).ordinal() != 0 : objZza != ((zzgh) objZza).zzi()) {
                        }
                        if (zEquals) {
                            zBooleanValue = false;
                        }
                    } else {
                        zBooleanValue = ((Boolean) zzez.zza(method5, zzghVar, new Object[0])).booleanValue();
                    }
                    if (zBooleanValue) {
        ...
        if (zzghVar instanceof zzez.zze) {
            Iterator<Map.Entry<T, Object>> itZzd = ((zzez.zze) zzghVar).zzc.zzd();
            if (itZzd.hasNext()) {
                throw new NoSuchMethodError();
            }
        }
        zzez zzezVar = (zzez) zzghVar;
        if (zzezVar.zzb != null) {
            zzezVar.zzb.zza(sb, i);
        }
    }
