...
public abstract class zzem extends zzdw {
    ...
    public abstract void zza(zzgh zzghVar) throws IOException;
    ...
    static class zzb extends zzem {
        ...
        final void zza(int i, zzgh zzghVar, zzgy zzgyVar) throws IOException {
            zza(i, 2);
            zzdq zzdqVar = (zzdq) zzghVar;
            int iZzg = zzdqVar.zzg();
            if (iZzg == -1) {
                iZzg = zzgyVar.zzb(zzdqVar);
                zzdqVar.zza(iZzg);
            }
            zzb(iZzg);
            zzgyVar.zza((zzgy) zzghVar, (zzik) this.zza);
        }
        ...
        @Override // com.google.android.gms.internal.mlkit_common.zzem
        public final void zza(zzgh zzghVar) throws IOException {
            zzb(zzghVar.zzj());
            zzghVar.zza(this);
        }
        ...
        public final void zzb(int i) throws IOException {
            ...
            if ((i & (-128)) == 0) {
                ...
                int i4 = this.zze;
                this.zze = i4 + 1;
                zzhw.zza(bArr3, i4, (byte) i);
                return;
            }
            byte[] bArr4 = this.zzb;
            int i5 = this.zze;
            this.zze = i5 + 1;
            zzhw.zza(bArr4, i5, (byte) (i | 128));
            int i6 = i >>> 7;
            if ((i6 & (-128)) == 0) {
                byte[] bArr5 = this.zzb;
                int i7 = this.zze;
                this.zze = i7 + 1;
                zzhw.zza(bArr5, i7, (byte) i6);
                return;
            }
            byte[] bArr6 = this.zzb;
            int i8 = this.zze;
            this.zze = i8 + 1;
            zzhw.zza(bArr6, i8, (byte) (i6 | 128));
            int i9 = i >>> 14;
            if ((i9 & (-128)) == 0) {
                byte[] bArr7 = this.zzb;
                int i10 = this.zze;
                this.zze = i10 + 1;
                zzhw.zza(bArr7, i10, (byte) i9);
                return;
            }
            byte[] bArr8 = this.zzb;
            int i11 = this.zze;
            this.zze = i11 + 1;
            zzhw.zza(bArr8, i11, (byte) (i9 | 128));
            int i12 = i >>> 21;
            if ((i12 & (-128)) == 0) {
                byte[] bArr9 = this.zzb;
                int i13 = this.zze;
                this.zze = i13 + 1;
                zzhw.zza(bArr9, i13, (byte) i12);
                return;
            }
            byte[] bArr10 = this.zzb;
            int i14 = this.zze;
            this.zze = i14 + 1;
            zzhw.zza(bArr10, i14, (byte) (i12 | 128));
            byte[] bArr11 = this.zzb;
            int i15 = this.zze;
            this.zze = i15 + 1;
            zzhw.zza(bArr11, i15, (byte) (i >>> 28));
        }
        ...
        @Override // com.google.android.gms.internal.mlkit_common.zzdw
        ...
        public final void zza(String str) throws IOException {
            ...
            try {
                ...
                if (iZzg2 == iZzg) {
                    int i2 = i + iZzg2;
                    this.zze = i2;
                    int iZza = zzhy.zza(str, this.zzb, i2, zza());
                    this.zze = i;
                    zzb((iZza - i) - iZzg2);
                    this.zze = iZza;
                    return;
                ...
                zzb(zzhy.zza(str));
                this.zze = zzhy.zza(str, this.zzb, this.zze, zza());
            } catch (zzhz e) {
                this.zze = i;
                zza(str, e);
    ...
    public static int zzc(int i, zzdv zzdvVar) {
        int iZze = zze(i);
        int iZza = zzdvVar.zza();
        return iZze + zzg(iZza) + iZza;
    }

    public static int zza(int i, zzfq zzfqVar) {
        int iZze = zze(i);
        int iZzb = zzfqVar.zzb();
        return iZze + zzg(iZzb) + iZzb;
    }

    static int zzb(int i, zzgh zzghVar, zzgy zzgyVar) {
        return zze(i) + zza(zzghVar, zzgyVar);
    }

    public static int zzb(int i, zzgh zzghVar) {
        return (zze(1) << 1) + zzg(2, i) + zze(3) + zzb(zzghVar);
    }
    ...
    public static int zzb(int i, zzfq zzfqVar) {
        return (zze(1) << 1) + zzg(2, i) + zza(3, zzfqVar);
    }
    ...
    public static int zzb(String str) {
        ...
        try {
            ...
            length = str.getBytes(zzfc.zza).length;
        }
        return zzg(length) + length;
    }

    public static int zza(zzfq zzfqVar) {
        int iZzb = zzfqVar.zzb();
    ...
    public static int zzb(zzgh zzghVar) {
        int iZzj = zzghVar.zzj();
        return zzg(iZzj) + iZzj;
    }

    static int zza(zzgh zzghVar, zzgy zzgyVar) {
        zzdq zzdqVar = (zzdq) zzghVar;
        int iZzg = zzdqVar.zzg();
        if (iZzg == -1) {
            iZzg = zzgyVar.zzb(zzdqVar);
    ...
    final void zza(String str, zzhz zzhzVar) throws IOException {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) zzhzVar);
        byte[] bytes = str.getBytes(zzfc.zza);
        try {
            zzb(bytes.length);
