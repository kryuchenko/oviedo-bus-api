...
final class zzfv extends zzdu<Long> implements zzfi<Long>, zzgu, RandomAccess {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzfvVar.zzc) {
            return false;
        }
        long[] jArr = zzfvVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzfc.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        System.arraycopy(zzfvVar.zzb, 0, this.zzb, this.zzc, zzfvVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final /* synthetic */ zzfi<Long> zzb(int i) {
        if (i < this.zzc) {
