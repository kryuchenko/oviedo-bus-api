...
final class zziv {
    ...
    private static final Logger zzb = Logger.getLogger(zziv.class.getName());
    ...
    static final class zza extends zzc {
        ...
        @Override // com.google.android.gms.internal.mlkit_vision_text.zziv.zzc
        public final byte zza(Object obj, long j) {
            if (zziv.zza) {
                return zziv.zzk(obj, j);
            }
            return zziv.zzl(obj, j);
        }
        ...
        public final boolean zzb(Object obj, long j) {
            if (zziv.zza) {
                return zziv.zzm(obj, j);
            }
            return zziv.zzn(obj, j);
        }
    ...
    private static Field zzf() {
        Field fieldZza;
        if (zzes.zza() && (fieldZza = zza((Class<?>) Buffer.class, "effectiveDirectAddress")) != null) {
            return fieldZza;
        }
    ...
    static {
        ...
        Field fieldZzf = zzf();
        zzw = (fieldZzf == null || zzdVar == null) ? -1L : zzdVar.zza.objectFieldOffset(fieldZzf);
        zzx = (int) (jZzb & 7);
