...
class zzhy<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private List<zzih> zzb;
    private Map<K, V> zzc;
    private boolean zzd;
    private volatile zzij zze;
    private Map<K, V> zzf;
    private volatile zzid zzg;

    static <FieldDescriptorType extends zzfs<FieldDescriptorType>> zzhy<FieldDescriptorType, Object> zza(int i) {
        return new zzib(i);
    }
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza((zzhy<K, V>) comparable) >= 0 || this.zzc.containsKey(comparable);
    }

    @Override // java.util.AbstractMap, java.util.Map
    public V get(Object obj) {
        Comparable comparable = (Comparable) obj;
        int iZza = zza((zzhy<K, V>) comparable);
        if (iZza >= 0) {
    ...
    public final V zza(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzih zzihVarRemove = this.zzb.remove(i2 - 1);
            zzg().put((Comparable) zzihVarRemove.getKey(), zzihVarRemove.getValue());
        }
        this.zzb.add(i, new zzih(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzih(this, it.next()));
            it.remove();
        }
        return v;
    }
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < iZzc; i++) {
            if (!zzb(i).equals(zzhyVar.zzb(i))) {
                return false;
            }
        }
        if (iZzc != size) {
            return this.zzc.equals(zzhyVar.zzc);
        }
        return true;
    }
    ...
    /* synthetic */ zzhy(int i, zzib zzibVar) {
        this(i);
    }
}
