...
public class DriveEventService extends Service implements ChangeListener, CompletionListener, zzd, zzi {
    ...
    public final synchronized IBinder onBind(Intent intent) {
        ...
        if (this.zzck == null && !this.zzcl) {
            ...
            try {
                if (!countDownLatch.await(DeviceOrientationRequest.OUTPUT_PERIOD_FAST, TimeUnit.MILLISECONDS)) {
    ...
    public synchronized void onDestroy() {
        ...
        if (zzaVar != null) {
            ...
            this.zzck = null;
            try {
                if (!this.zzcj.await(DeviceOrientationRequest.OUTPUT_PERIOD_FAST, TimeUnit.MILLISECONDS)) {
