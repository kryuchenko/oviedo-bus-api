        ...
        if (this.zaa.zaD()) {
            ...
            if ((config == null || config.getMethodInvocationTelemetryEnabled()) && (zabqVarZai = this.zaa.zai(this.zac)) != null && (zabqVarZai.zaf() instanceof BaseGmsClient)) {
                ...
                if (config != null) {
                    ...
                    version = 0;
                    i = BaseUtils.INFO_MESSAGE_VISIBILITY_MS;
                    i2 = 100;
                }
                ...
                googleApiManager.zaw(new MethodInvocation(this.zab, i3, errorCode, j, jCurrentTimeMillis, null, null, gCoreServiceId, iElapsedRealtime), version, i, i2);
            }
        }
    }
}
