...
public final class zzaps extends zzatu implements zzavg {
    ...
    private String zzp = "";
    private String zzq = "";
    private zzauc zzr = zzax();
    private String zzw = "";
    private String zzx = "";
    private zzauc zzy = zzax();
    private zzauc zzB = zzax();
    private String zzC = "";
    private zzauc zzF = zzax();
    private String zzH = "";
    private String zzI = "";
    private zzauc zzW = zzax();
    private zzauc zzX = zzax();
    private zzauc zzan = zzax();
    private zzauc zzay = zzax();
