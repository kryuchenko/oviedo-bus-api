...
class ClockHandView extends View {
    ...
    public void setHandRotation(float f, boolean z) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.timepicker.ClockHandView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m555xb17f7076(valueAnimator2);
            }
        });
    ...
    /* synthetic */ void m555xb17f7076(ValueAnimator valueAnimator) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 1 || actionMasked == 2) {
                ...
                z3 = z4;
                z2 = false;
                zHandleTouchInput = this.changedDuringTouch | handleTouchInput(x, y, z, z2, z3);
