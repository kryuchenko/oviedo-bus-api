...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM580m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM580m = Timestamp$$ExternalSyntheticApiModelOutline0.m580m(getContext().getSystemService(Timestamp$$ExternalSyntheticApiModelOutline0.m582m()))) != null) {
                autofillManagerM580m.notifyValueChanged(this);
            }
