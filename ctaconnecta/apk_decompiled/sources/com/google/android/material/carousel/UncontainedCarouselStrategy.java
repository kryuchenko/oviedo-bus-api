...
public final class UncontainedCarouselStrategy extends CarouselStrategy {
    ...
    KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        return createLeftAlignedKeylineState(view.getContext(), f3, containerWidth, f4, iMax, calculateMediumChildSize(extraSmallSize, f4, f5), f5 > 0.0f ? 1 : 0, extraSmallSize2);
    }
