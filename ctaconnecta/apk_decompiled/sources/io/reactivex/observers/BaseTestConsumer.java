...
public abstract class BaseTestConsumer<T, U extends BaseTestConsumer<T, U>> implements Disposable {
    ...
    */
    ...
    public final U awaitCount(int i) {
        return (U) awaitCount(i, TestWaitStrategy.SLEEP_10MS, DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    }

    public final U awaitCount(int i, Runnable runnable) {
        return (U) awaitCount(i, runnable, DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
    }
