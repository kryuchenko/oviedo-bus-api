...
public class QuantStepSizeSpec extends ModuleSpec {
    ...
    public QuantStepSizeSpec(int i, int i2, byte b, ParameterList parameterList) {
        super(i, i2, b);
        String parameter = parameterList.getParameter("Qstep");
        if (parameter == null) {
                ...
                if (cCharAt == 'c') {
                    ...
                    try {
                        ...
                        if (f.floatValue() <= 0.0f) {
                            throw new IllegalArgumentException("Normalized base step must be positive : " + f);
                        }
                        if (c == 0) {
                            setDefault(f);
                        } else if (c == 2) {
                        ...
                        throw new IllegalArgumentException("Bad parameter for -Qstep option : " + lowerCase);
                    }
                }
            }
            if (getDefault() == null) {
                ...
                if (i4 != 0) {
                    setDefault(new Float(parameterList.getDefaultParameterList().getParameter("Qstep")));
                    return;
                }
