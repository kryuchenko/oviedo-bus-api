...
public final class Hex {
    ...
    public static String byteToHexString(byte b) {
        ...
        sb.append(i < 16 ? StdEntropyCoder.DEF_THREADS_NUM : "");
    ...
    public static String shortToHexString(short s) {
        ...
        sb.append(i < 4096 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        sb.append(i < 256 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        if (i >= 16) {
            str = "";
        }
        sb.append(str);
    ...
    public static String intToHexString(int i) {
        StringBuilder sb = new StringBuilder();
        String str = StdEntropyCoder.DEF_THREADS_NUM;
        sb.append(i < 268435456 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        sb.append(i < 16777216 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        sb.append(i < 1048576 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        sb.append(i < 65536 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        sb.append(i < 4096 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        sb.append(i < 256 ? StdEntropyCoder.DEF_THREADS_NUM : "");
        if (i >= 16) {
            str = "";
    ...
    public static byte[] hexStringToBytes(String str) throws NumberFormatException {
        ...
        if (sb.length() % 2 != 0) {
            sb.insert(0, StdEntropyCoder.DEF_THREADS_NUM);
        }
