    ...
    public final void androidLog$okhttp(String loggerName, int logLevel, String message, Throwable t) {
        ...
        if (Log.isLoggable(strLoggerTag, logLevel)) {
            ...
            while (i < length) {
                ...
                while (true) {
                    int iMin = Math.min(iIndexOf$default, i + MAX_LOG_LENGTH);
                    if (message == null) {
