...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void initReaderAndWriter(final String name, Streams streams) throws Throwable {
        ...
        synchronized (this) {
            try {
                ...
                Unit unit = Unit.INSTANCE;
                realWebSocket.reader = new WebSocketReader(streams2.getClient(), streams2.getSource(), realWebSocket, webSocketExtensions.perMessageDeflate, webSocketExtensions.noContextTakeover(!streams2.getClient()));
            } catch (Throwable th2) {
                th = th2;
            }
        }
    ...
    /* JADX WARN: Type inference failed for: r1v21, types: [T, okhttp3.internal.ws.RealWebSocket$Streams] */
    /* JADX WARN: Type inference failed for: r1v24, types: [T, okhttp3.internal.ws.WebSocketReader] */
    /* JADX WARN: Type inference failed for: r1v27, types: [T, okhttp3.internal.ws.WebSocketWriter] */
    ...
    public final boolean writeOneFrame$okhttp() throws IOException {
        ...
        synchronized (this) {
            ...
            if (byteStringPoll == null) {
                objectRef.element = this.messageAndCloseQueue.poll();
                if (objectRef.element instanceof Close) {
            ...
            try {
                ...
                } else if (objectRef.element instanceof Message) {
                ...
                } else if (objectRef.element instanceof Close) {
