...
public final class Relay {
    ...
    public final class RelaySource implements Source, AutoCloseable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:31:0x00af, code lost:
            ...
            r13 = r0.read(r19.this$0.getUpstreamBuffer(), r19.this$0.getBufferMaxSize());
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:46:0x00f8, code lost:
            ...
            r6 = java.lang.Math.min(r13, r21);
            r19.this$0.getUpstreamBuffer().copyTo(r20, 0, r6);
            r19.sourcePos += r6;
            r13 = r19.fileOperator;
            kotlin.jvm.internal.Intrinsics.checkNotNull(r13);
            r13.write(r19.this$0.getUpstreamPos() + 32, r19.this$0.getUpstreamBuffer().clone(), r13);
            r4 = r19.this$0;
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:48:0x012f, code lost:
            ...
            r19.this$0.getBuffer().write(r19.this$0.getUpstreamBuffer(), r13);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:51:0x016c, code lost:
            ...
            r0 = r19.this$0;
            r0.setUpstreamPos(r0.getUpstreamPos() + r13);
            r0 = kotlin.Unit.INSTANCE;
         */
                ...
                while (true) {
                    if (this.sourcePos == Relay.this.getUpstreamPos()) {
                        ...
                        if (this.sourcePos >= upstreamPos) {
                            ...
                            Relay.this.getBuffer().copyTo(sink2, this.sourcePos - upstreamPos, jMin);
                            this.sourcePos += jMin;
                            return jMin;
                        }
                        c = 2;
