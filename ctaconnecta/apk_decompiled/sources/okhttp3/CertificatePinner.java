    ...
    public static final class Pin {
        ...
        public final boolean matchesHostname(String hostname) {
            ...
            if (StringsKt.startsWith$default(this.pattern, "**.", false, 2, (Object) null)) {
                ...
                return StringsKt.regionMatches(hostname, hostname.length() - length, this.pattern, 3, length, (16 & 16) != 0 ? false : false) && (length2 == 0 || hostname.charAt(length2 - 1) == '.');
            }
            if (StringsKt.startsWith$default(this.pattern, "*.", false, 2, (Object) null)) {
                int length3 = this.pattern.length() - 1;
                return StringsKt.regionMatches(hostname, hostname.length() - length3, this.pattern, 1, length3, (16 & 16) != 0 ? false : false) && StringsKt.lastIndexOf$default((CharSequence) hostname, '.', (hostname.length() - length3) + (-1), false, 4, (Object) null) == -1;
            }
