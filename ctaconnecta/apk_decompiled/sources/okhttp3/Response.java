...
public final class Response implements Closeable, AutoCloseable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = Constants.Notification.DATA_MESSAGE, imports = {}))
    ...
    public final CacheControl m2671deprecated_cacheControl() {
        return cacheControl();
    }
