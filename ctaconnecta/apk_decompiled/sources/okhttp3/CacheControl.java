        ...
        */
        public final CacheControl parse(Headers headers) {
            ...
            while (i2 < size) {
                ...
                if (!StringsKt.equals(strName, HttpHeaders.CACHE_CONTROL, z2)) {
                    if (!StringsKt.equals(strName, HttpHeaders.PRAGMA, z2)) {
                        continue;
                        i2++;
                        headers2 = headers;
                        size = size;
                    ...
                    while (i < strValue.length()) {
                        ...
                        if (iIndexOfElement != strValue.length()) {
                            ...
                            if (!StringsKt.equals("no-cache", string2, true)) {
                                ...
                                z5 = true;
                            } else if (StringsKt.equals("max-age", string2, true)) {
