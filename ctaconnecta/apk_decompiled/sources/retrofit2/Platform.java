...
class Platform {
    ...
    Platform(boolean z) throws NoSuchMethodException, SecurityException {
        ...
        if (z) {
            try {
                declaredConstructor = Platform$$ExternalSyntheticApiModelOutline0.m$2().getDeclaredConstructor(Class.class, Integer.TYPE);
    ...
    Object invokeDefaultMethod(Method method, Class<?> cls, Object obj, Object... objArr) throws Throwable {
        ...
        return (constructor != null ? Platform$$ExternalSyntheticApiModelOutline0.m((Object) constructor.newInstance(cls, -1)) : MethodHandles.lookup()).unreflectSpecial(method, cls).bindTo(obj).invokeWithArguments(objArr);
    }
