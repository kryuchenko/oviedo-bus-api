...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2541scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m2472delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2473toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2473toDelayMillisLRDsOJo(long j) {
        if (Duration.m2307compareToLRDsOJo(j, Duration.INSTANCE.m2411getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2326getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
