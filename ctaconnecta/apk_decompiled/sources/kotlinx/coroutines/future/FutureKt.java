...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> completableFutureM2728m = Platform$$ExternalSyntheticApiModelOutline0.m2728m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM2728m);
        completableFutureM2728m.handle(Platform$$ExternalSyntheticApiModelOutline0.m2730m((Object) completableFutureCoroutine));
        completableFutureCoroutine.start(coroutineStart, completableFutureCoroutine, function2);
        return completableFutureM2728m;
    }

    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM2728m = Platform$$ExternalSyntheticApiModelOutline0.m2728m();
        setupCancellation(deferred, completableFutureM2728m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.1
            ...
            public final void invoke2(Throwable th) {
                try {
                    completableFutureM2728m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    completableFutureM2728m.completeExceptionally(th2);
                }
            }
        });
        return completableFutureM2728m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM2728m = Platform$$ExternalSyntheticApiModelOutline0.m2728m();
        setupCancellation(job, completableFutureM2728m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    completableFutureM2728m.complete(Unit.INSTANCE);
                } else {
                    completableFutureM2728m.completeExceptionally(th);
                }
            }
        });
        return completableFutureM2728m;
    ...
    public static final <T> Deferred<T> asDeferred(CompletionStage<T> completionStage) {
        ...
        final Function2<T, Throwable, Object> function2 = new Function2<T, Throwable, Object>() { // from class: kotlinx.coroutines.future.FutureKt.asDeferred.2
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Throwable th2) {
                return invoke2((C02752<T>) obj, th2);
            }
            ...
            public final Object invoke2(T t, Throwable th2) {
                ...
                try {
                    if (th2 == null) {
                        ...
                        CompletionException completionExceptionM2729m = Platform$$ExternalSyntheticApiModelOutline0.m2733m((Object) th2) ? Platform$$ExternalSyntheticApiModelOutline0.m2729m((Object) th2) : null;
                        if (completionExceptionM2729m != null && (cause2 = completionExceptionM2729m.getCause()) != null) {
                            th2 = cause2;
                        }
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) throws Throwable {
        ...
        completionStage.handle(Platform$$ExternalSyntheticApiModelOutline0.m2730m((Object) continuationHandler));
