...
final class ContinuationHandler<T> implements BiFunction<T, Throwable, Unit> {
    ...
    public void apply2(T result, Throwable exception) {
        ...
        if (exception == null) {
            ...
            continuation.resumeWith(Result.m936constructorimpl(result));
            return;
        }
        CompletionException completionExceptionM2729m = Platform$$ExternalSyntheticApiModelOutline0.m2733m((Object) exception) ? Platform$$ExternalSyntheticApiModelOutline0.m2729m((Object) exception) : null;
        if (completionExceptionM2729m != null && (cause = completionExceptionM2729m.getCause()) != null) {
            exception = cause;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m936constructorimpl(ResultKt.createFailure(exception)));
    }
}
