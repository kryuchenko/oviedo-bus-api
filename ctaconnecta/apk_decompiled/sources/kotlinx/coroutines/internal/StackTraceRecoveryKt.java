...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM936constructorimpl = Result.m936constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM936constructorimpl = Result.m936constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m939exceptionOrNullimpl(objM936constructorimpl) == null) {
            obj2 = objM936constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM936constructorimpl2 = Result.m936constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM936constructorimpl2 = Result.m936constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m939exceptionOrNullimpl(objM936constructorimpl2) == null) {
            obj = objM936constructorimpl2;
        }
