    ...
    */
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
            ...
            dispatchedContinuation.dispatcher.mo2540dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
            return;
        }
        ...
        if (job != null && !job.isActive()) {
            ...
            dispatchedContinuation.resumeWith(Result.m936constructorimpl(ResultKt.createFailure(cancellationException)));
        } else {
