...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM936constructorimpl = Result.m936constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM936constructorimpl = Result.m936constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m942isFailureimpl(objM936constructorimpl)) {
                objM936constructorimpl = null;
            }
            return (E) objM936constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM936constructorimpl = Result.m936constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM936constructorimpl = Result.m936constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m942isFailureimpl(objM936constructorimpl) ? null : objM936constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM936constructorimpl = Result.m936constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM936constructorimpl = Result.m936constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m942isFailureimpl(objM936constructorimpl)) {
            objM936constructorimpl = numValueOf;
        }
        return ((Number) objM936constructorimpl).intValue();
    }
