...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C02771 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C02771(SelectImplementation<R> selectImplementation, Continuation<? super C02771> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C02771) {
            ...
            if ((c02771.label & Integer.MIN_VALUE) != 0) {
                ...
                c02771 = new C02771(this, continuation);
            }
        }
        Object obj2 = c02771.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c02771.label;
        try {
            if (i != 0) {
            ...
            c02771.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c02771);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c02771 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c02771);
            }
            throw th;
        }
    }
