...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM936constructorimpl = Result.m936constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM936constructorimpl = Result.m936constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m942isFailureimpl(objM936constructorimpl) ? null : objM936constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2540dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
