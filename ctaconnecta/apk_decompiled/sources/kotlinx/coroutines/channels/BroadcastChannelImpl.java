...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo2484trySendJP2dKIU(getValue());
                }
    ...
    */
    public Object send(E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            if (it.hasNext()) {
                ...
                anonymousClass1.L$1 = e2;
                anonymousClass1.L$2 = it;
                anonymousClass1.label = 1;
                Object objSendBroadcast$kotlinx_coroutines_core = bufferedChannel.sendBroadcast$kotlinx_coroutines_core(e2, anonymousClass1);
    ...
    public Object mo2484trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2484trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2484trySendJP2dKIU(element);
            }
