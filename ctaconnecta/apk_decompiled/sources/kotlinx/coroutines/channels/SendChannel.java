...
public interface SendChannel<E> {
    ...
    Object mo2484trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2504isSuccessimpl(objMo2484trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2498exceptionOrNullimpl = ChannelResult.m2498exceptionOrNullimpl(objMo2484trySendJP2dKIU);
