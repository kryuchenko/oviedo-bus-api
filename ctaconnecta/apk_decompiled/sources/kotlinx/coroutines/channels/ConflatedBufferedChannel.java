...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2512trySendImplMj0NB7M = conflatedBufferedChannel.m2512trySendImplMj0NB7M(e, true);
        if (objM2512trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2498exceptionOrNullimpl(objM2512trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2512trySendImplMj0NB7M = conflatedBufferedChannel.m2512trySendImplMj0NB7M(e, true);
        if (!(objM2512trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2484trySendJP2dKIU(E element) {
        return m2512trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2512trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2510trySendDropLatestMj0NB7M(element, isSendOp) : m2511trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2510trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2484trySendJP2dKIU = super.mo2484trySendJP2dKIU(element);
        if (ChannelResult.m2504isSuccessimpl(objMo2484trySendJP2dKIU) || ChannelResult.m2502isClosedimpl(objMo2484trySendJP2dKIU)) {
            return objMo2484trySendJP2dKIU;
        }
    ...
    private final Object m2511trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2484trySendJP2dKIU = mo2484trySendJP2dKIU(element);
        if (!(objMo2484trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2484trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2498exceptionOrNullimpl(objMo2484trySendJP2dKIU);
