...
public interface ReceiveChannel<E> {
    ...
    Object mo2488receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2489tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2489tryReceivePtdJZtk = receiveChannel.mo2489tryReceivePtdJZtk();
            if (ChannelResult.m2504isSuccessimpl(objMo2489tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2500getOrThrowimpl(objMo2489tryReceivePtdJZtk);
            }
            Throwable thM2498exceptionOrNullimpl = ChannelResult.m2498exceptionOrNullimpl(objMo2489tryReceivePtdJZtk);
            if (thM2498exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2498exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo2488receiveCatchingJP2dKIU = receiveChannel.mo2488receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m2499getOrNullimpl(objMo2488receiveCatchingJP2dKIU);
        }
