...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM936constructorimpl = Result.m936constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM936constructorimpl = Result.m936constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m942isFailureimpl(objM936constructorimpl) ? null : objM936constructorimpl);
