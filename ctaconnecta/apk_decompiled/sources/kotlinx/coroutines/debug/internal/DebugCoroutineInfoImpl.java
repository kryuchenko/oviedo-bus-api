...
public final class DebugCoroutineInfoImpl {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl", f = "DebugCoroutineInfoImpl.kt", i = {0, 0, 0}, l = {CipherSuite.TLS_DHE_PSK_WITH_AES_256_GCM_SHA384}, m = "yieldFrames", n = {"this", "$this$yieldFrames", TypedValues.AttributesType.S_FRAME}, s = {"L$0", "L$1", "L$2"})
    ...
    @DebugMetadata(c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$creationStackTrace$1", f = "DebugCoroutineInfoImpl.kt", i = {}, l = {CipherSuite.TLS_DH_anon_WITH_AES_128_GCM_SHA256}, m = "invokeSuspend", n = {}, s = {})
    ...
    */
    public final Object yieldFrames(SequenceScope<? super StackTraceElement> sequenceScope, CoroutineStackFrame coroutineStackFrame, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            CoroutineStackFrame coroutineStackFrame2 = (CoroutineStackFrame) c02551.L$2;
            SequenceScope<? super StackTraceElement> sequenceScope2 = (SequenceScope) c02551.L$1;
            debugCoroutineInfoImpl = (DebugCoroutineInfoImpl) c02551.L$0;
            ResultKt.throwOnFailure(obj);
            ...
            if (coroutineStackFrame == null) {
                ...
                if (stackTraceElement != null) {
                    c02551.L$0 = debugCoroutineInfoImpl;
                    c02551.L$1 = sequenceScope;
                    c02551.L$2 = coroutineStackFrame;
                    c02551.label = 1;
                    if (sequenceScope.yield(stackTraceElement, c02551) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
